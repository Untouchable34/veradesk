    ...
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    {
        ...
        #[cfg(target_os = "macos")]
        {
            ...
            INIT.call_once(|| {
                ...
                // https://github.com/rustdesk/veradesk/blob/85db6779828349b23ca3eba91cc7cd36c5337797/src/common.rs#L822
...
pub const VER_TYPE_VERADESK_CLIENT: &str = "veradesk-client";
pub const VER_TYPE_VERADESK_SERVER: &str = "veradesk-server";

pub fn version_check_request(typ: String) -> (VersionCheckRequest, String) {
    const URL: &str = "https://api.veranilsoft.com/version/latest";
