//! WebRTC transport for VeraDesk streams.
//!
...
pub struct WebRTCStream {
    ...
    // True once the controller has completed the VeraDesk identity binding (DTLS fingerprint
...
impl WebRTCStream {
    ...
    /// which both veradesk signaling paths do. Remaining callers are the loopback tests and
