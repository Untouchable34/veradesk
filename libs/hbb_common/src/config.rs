...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("com.veranilsoft".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new(VERADESK_RENDEZVOUS_SERVER.to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new(VERADESK_APP_NAME.to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://veranilsoft.com/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://veranilsoft.com/docs/en/manual/linux/#x11-required";

lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("veradesk docs home", LINK_DOCS_HOME),
        ("veradesk docs x11-required", LINK_DOCS_X11_REQUIRED),
        ]);
}
