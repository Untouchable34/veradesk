...
pub fn check_ws(endpoint: &str) -> String {
    ...
    let (relay, dst_port) = if endpoint_port == rendezvous_port {
        ...
        // relay
        // https://github.com/rustdesk/veradesk/blob/6ffbcd1375771f2482ec4810680623a269be70f1/src/rendezvous_mediator.rs#L615
        // https://github.com/rustdesk/veradesk-server/blob/235a3c326ceb665e941edb50ab79faa1208f7507/src/relay_server.rs#L83, based on relay port.
...
mod tests {
    ...
    fn test_check_ws() {
        ...
        assert_eq!(check_ws("veranilsoft.com:21115"), "ws://veranilsoft.com/ws/id");
        assert_eq!(check_ws("veranilsoft.com:21116"), "ws://veranilsoft.com/ws/id");
        assert_eq!(check_ws("veranilsoft.com:21117"), "ws://veranilsoft.com/ws/relay");
        // set relay-server without port
        Config::set_option("relay-server".to_string(), "127.0.0.1".to_string());
        Config::set_option(
            "api-server".to_string(),
            "https://api.veranilsoft.com".to_string(),
        );
        assert_eq!(
        ...
        assert_eq!(check_ws("veranilsoft.com:21115"), "wss://veranilsoft.com/ws/id");
        assert_eq!(check_ws("veranilsoft.com:21116"), "wss://veranilsoft.com/ws/id");
        assert_eq!(
            check_ws("veranilsoft.com:21117"),
            "wss://veranilsoft.com/ws/relay"
        );
        ...
        assert_eq!(check_ws("veranilsoft.com:21116"), "wss://veranilsoft.com/ws/id");
        assert_eq!(
            check_ws("veranilsoft.com:34567"),
            "wss://veranilsoft.com/ws/relay"
        );
