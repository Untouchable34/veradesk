...
#
# - versionName from https://github.com/rustdesk/rustdesk/releases/download/fdroid-version/veradesk-version.txt
# - versionCode from https://github.com/rustdesk/rustdesk/releases/download/fdroid-version/veradesk-version.txt
