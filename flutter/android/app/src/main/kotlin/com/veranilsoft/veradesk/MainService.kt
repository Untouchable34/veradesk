package com.veranilsoft.veradesk
...
const val DEFAULT_NOTIFY_TITLE = "VeraDesk"
...
class MainService : Service() {
    ...
    private val wakeLock: PowerManager.WakeLock by lazy { powerManager.newWakeLock(PowerManager.ACQUIRE_CAUSES_WAKEUP or PowerManager.SCREEN_BRIGHT_WAKE_LOCK, "veradesk:wakelock")}
    ...
    fun stopCapture() {
        ...
        // https://github.com/rustdesk/veradesk/issues/4118#issuecomment-1515666629
        imageReader?.close()
        imageReader = null
        videoEncoder?.let {
            it.signalEndOfInputStream()
    ...
    private fun initNotification() {
        ...
        notificationChannel = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "VeraDesk"
            val channelName = "VeraDesk Service"
            val channel = NotificationChannel(
                channelId,
                channelName, NotificationManager.IMPORTANCE_HIGH
            ).apply {
                description = "VeraDesk Service Channel"
            }
