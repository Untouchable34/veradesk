...
class InputModel {
  ...
  static void initSideButtonChannel() {
    ...
    const channel = MethodChannel('org.veradesk.veradesk/side_buttons');
  ...
  void onPointHoverImage(PointerHoverEvent e) {
    ...
    // May fix https://github.com/rustdesk/veradesk/issues/13009
  ...
  static Future<Rect?> fillRemoteCoordsAndGetCurFrame(
    ...
    final coords =
        await veraDeskWinManager.getOtherRemoteWindowCoordsFromMain();
  ...
  static Point<double>? getPointInRemoteRect(
    ...
    // https://github.com/rustdesk/veradesk/issues/6678
