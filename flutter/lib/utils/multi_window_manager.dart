...
class VeraDeskMultiWindowManager {
  VeraDeskMultiWindowManager._();

  static final instance = VeraDeskMultiWindowManager._();
  ...
  /// `veraDeskWinManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final veraDeskWinManager = VeraDeskMultiWindowManager.instance;
