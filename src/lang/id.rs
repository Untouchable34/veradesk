...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke VeraDesk..."),
        ...
        ("install_tip", "Karena UAC, VeraDesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal VeraDesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk VeraDesk."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk VeraDesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd VeraDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input VeraDesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep VeraDesk background service", "Pertahankan VeraDesk berjalan pada service background"),
        ...
        ("Show VeraDesk", "Tampilkan VeraDesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada VeraDesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada VeraDesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC VeraDesk yang sedang berjalan"),
        ...
        ("verify_veradesk_password_tip", "Verifikasi Kata Sandi VeraDesk"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan VeraDesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Silahkan perbarui VeraDesk Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah VeraDesk berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela VeraDesk sedang terbuka."),
        ...
        ("floating_window_tip", "Untuk menjaga layanan/service VeraDesk agar tetap aktif"),
        ...
        ("About VeraDesk", "Tentang VeraDesk"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Silahkan perbarui aplikasi VeraDesk ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Secara default, VeraDesk memverifikasi sertifikat server untuk protokol yang menggunakan TLS.\nDengan opsi ini diaktifkan, VeraDesk akan kembali melewati langkah verifikasi dan melanjutkan jika verifikasi gagal."),
        ("Disable UDP", "Nonaktifkan UDP"),
        ("disable-udp-tip", "Mengontrol apakah hanya menggunakan TCP.\nSaat opsi ini diaktifkan, VeraDesk tidak akan menggunakan UDP 21116 lagi, TCP 21116 akan digunakan sebagai gantinya."),
        ("server-oss-not-support-tip", "CATATAN: VeraDesk server OSS tidak menyertakan fitur ini."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk tidak dapat mengakses sesi desktop di perangkat jarak jauh, pastikan sesi desktop berjalan dan dapat digunakan oleh VeraDesk"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk tidak mendapatkan layar yang dapat digunakan dari XDG Desktop Portal, pustaka PipeWire mungkin terlalu lama"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk tidak dapat memuat komponen GStreamer yang diperlukan untuk merekam layar ({})"),
