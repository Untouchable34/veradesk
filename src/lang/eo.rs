...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Konektante al la reto VeraDesk..."),
        ...
        ("install_tip", "Vi ne uzas instalita versio. Pro limigoj pro UAC, kiel aparato kontrolata, en kelkaj kazoj, ne estos ebla kontroli la muson kaj klavaron aŭ registri la ekranon. Bonvolu alkliku la butonon malsupre por instali VeraDesk sur la operaciumo por eviti la demando supre."),
        ("Click to upgrade", "Alklaki por plibonigi"),
        ("Configure", "Konfiguri"),
        ("config_acc", "Por uzi vian foran aparaton, bonvolu doni la permeson \"alirebleco\" al VeraDesk."),
        ("config_screen", "Por uzi vian foran aparaton, bonvolu doni la permeson \"ekranregistrado\" al VeraDesk."),
        ...
        ("android_input_permission_tip1", "Por ke fora aparato regu vian Android-aparaton per muso aŭ tuŝo, vi devas permesi al VeraDesk uzi la servon \"Alirebleco\"."),
        ("android_input_permission_tip2", "Bonvolu iri al la sekva paĝo de sistemaj agordoj, trovi kaj eniri [Instatajn Servojn], ŝalti la servon [VeraDesk Enigo]."),
        ...
        ("Language", "Lingvo"),
        ("Keep VeraDesk background service", "Tenu VeraDesk fonan servon"),
        ("Ignore Battery Optimizations", "Ignoru Bateria Optimumigojn"),
        ("android_open_battery_optimizations_tip", "Se vi volas malŝalti ĉi tiun funkcion, bonvolu iri al la sekva paĝo de agordoj de la aplikaĵo de VeraDesk, trovi kaj eniri [Baterio], Malmarku [Senrestrikta]"),
        ...
        ("config_input", "Por kontroli la foran labortablon per klavaro, vi devas doni al VeraDesk permeson \"Eniga Monitorado\"."),
        ("config_microphone", "Por paroli fore, vi devas doni al VeraDesk permeson \"Registri Sonon\"."),
        ...
        ("still_click_uac_tip", "Ankoraŭ postulas ke la fora uzanto alklaku Bone en la UAC-fenestro de la funkcianta VeraDesk."),
        ...
        ("verify_veradesk_password_tip", "Kontroli VeraDesk-pasvorton"),
        ...
        ("scam_text1", "Se vi telefonas kun iu kiun vi NE konas KAJ FIDAS, kiu petis vin uzi VeraDesk kaj komenci la servon, ne daŭrigu kaj tuj malŝaltu la telefonon."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Bonvolu ĝisdatigi VeraDesk Server Pro al versio {} aŭ pli nova!"),
        ...
        ("selinux_tip", "SELinux estas ebligita sur via aparato, kio povas malhelpi VeraDesk funkcii ĝuste kiel kontrolata flanko."),
        ...
        ("powered_by_me", "Funkciigita de VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permesi konekton nur se la fenestro de VeraDesk estas malfermita"),
        ...
        ("floating_window_tip", "Ĝi helpas teni la fonan servon de VeraDesk"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Bonvolu ĝisdatigi la VeraDesk-klienton al versio {} aŭ pli nova ĉe la fora flanko!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Implicite, VeraDesk kontrolas la servilan atestilon por protokoloj uzantaj TLS.\nKun ĉi tiu opcio ebligita, VeraDesk retrokadros al preterlaso de la kontrola paŝo kaj daŭrigos en kazo de kontrola malsukceso."),
        ("Disable UDP", "Malebligi UDP"),
        ("disable-udp-tip", "Regas ĉu uzi nur TCP.\nKiam ĉi tiu opcio estas ebligita, VeraDesk ne plu uzos UDP 21116, TCP 21116 estos uzata anstataŭe."),
        ("server-oss-not-support-tip", "NOTU: VeraDesk-servilo OSS ne inkluzivas ĉi tiun funkcion."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk ne povas atingi la labortablan seancon sur la fora aparato, kontrolu ke seanco funkcias kaj ke VeraDesk povas uzi ĝin"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk ne povis akiri uzeblan ekranon de XDG Desktop Portal, la biblioteko PipeWire eble estas tro malnova"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk ne povis ŝargi komponanton de GStreamer necesan por ekrankapto ({})"),
