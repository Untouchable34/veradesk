...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Hazır"),
        ("Established", "Quruldu"),
        ("connecting_status", "VeraDesk şəbəkəsinə qoşulur..."),
        ...
        ("install_tip", "UAC səbəbindən VeraDesk bəzi hallarda uzaq tərəf kimi düzgün işləyə bilmir. UAC-dan yayınmaq üçün aşağıdakı düyməyə basaraq VeraDesk-i sistemə quraşdırın."),
        ("Click to upgrade", "Yeniləmək üçün klikləyin"),
        ("Configure", "Konfiqurasiya et"),
        ("config_acc", "Masaüstünüzü uzaqdan idarə etmək üçün VeraDesk-ə \"Əlçatanlıq\" icazələrini verməlisiniz."),
        ("config_screen", "Masaüstünüzə uzaqdan giriş üçün VeraDesk-ə \"Ekran Yazısı\" icazələrini verməlisiniz."),
        ...
        ("android_input_permission_tip1", "Uzaq cihazın siçan və ya toxunuşla Android cihazınızı idarə etməsi üçün VeraDesk-ə \"Əlçatanlıq\" xidmətindən istifadə icazəsi verməlisiniz."),
        ("android_input_permission_tip2", "Növbəti sistem parametrləri səhifəsinə keçin, [Quraşdırılmış xidmətlər] bölməsini tapıb açın və [VeraDesk Input] xidmətini işə salın."),
        ...
        ("Language", "Dil"),
        ("Keep VeraDesk background service", "VeraDesk fon xidmətini işlək saxla"),
        ("Ignore Battery Optimizations", "Batareya optimallaşdırmalarını nəzərə alma"),
        ("android_open_battery_optimizations_tip", "Bu funksiyanı söndürmək istəyirsinizsə, növbəti VeraDesk tətbiq parametrləri səhifəsinə keçin, [Batareya] bölməsini tapıb açın və [Məhdudiyyətsiz] seçimini götürün"),
        ...
        ("Show VeraDesk", "VeraDesk-i göstər"),
        ("This PC", "Bu kompüter"),
        ("or", "və ya"),
        ...
        ("config_input", "Uzaq masaüstünü klaviatura ilə idarə etmək üçün VeraDesk-ə \"Giriş Monitorinqi\" icazələrini verməlisiniz."),
        ("config_microphone", "Uzaqdan danışmaq üçün VeraDesk-ə \"Audio Yazısı\" icazələrini verməlisiniz."),
        ...
        ("still_click_uac_tip", "Yenə də uzaq istifadəçinin işləyən VeraDesk-in UAC pəncərəsində OK düyməsini basması tələb olunur."),
        ...
        ("verify_veradesk_password_tip", "VeraDesk parolunu doğrula"),
        ...
        ("scam_text1", "Tanımadığınız və ETİBAR ETMƏDİYİNİZ biri telefonda sizdən VeraDesk işlətməyi və xidməti başlatmağı xahiş edirsə, davam etməyin və dərhal telefonu bağlayın."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "VeraDesk Server Pro-nu {} və ya daha yeni versiyaya yüksəldin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux aktivdir, bu, VeraDesk-in idarə olunan tərəf kimi düzgün işləməsinə mane ola bilər."),
        ...
        ("powered_by_me", "VeraDesk ilə işləyir"),
        ...
        ("allow-only-conn-window-open-tip", "Əlaqəyə yalnız VeraDesk pəncərəsi açıq olduqda icazə ver"),
        ...
        ("floating_window_tip", "VeraDesk fon xidmətini işlək saxlamağa kömək edir"),
        ...
        ("About VeraDesk", "VeraDesk haqqında"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Uzaq tərəfdə VeraDesk klientini {} və ya daha yeni versiyaya yüksəldin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standart olaraq VeraDesk TLS işlədən protokollar üçün server sertifikatını yoxlayır.\nBu seçim aktiv olduqda, yoxlama alınmadığı halda VeraDesk yoxlama addımını keçib davam edəcək."),
        ("Disable UDP", "UDP-ni söndür"),
        ("disable-udp-tip", "Yalnız TCP işlədilib işlədilməyəcəyini idarə edir.\nBu seçim aktiv olduqda VeraDesk artıq UDP 21116 işlətməyəcək, əvəzində TCP 21116 işlədiləcək."),
        ("server-oss-not-support-tip", "QEYD: VeraDesk server OSS bu funksiyanı əhatə etmir."),
