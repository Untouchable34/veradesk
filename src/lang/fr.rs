...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établie"),
        ("connecting_status", "Connexion au réseau VeraDesk…"),
        ...
        ("install_tip", "VeraDesk n’est pas installé, ce qui peut limiter son utilisation à cause de l’UAC. Cliquez ci-dessous pour l’installer."),
        ...
        ("android_input_permission_tip1", "Pour qu’un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher d’écran, vous devez autoriser VeraDesk à utiliser le service « Accessibilité »."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, puis recherchez et accédez à la section [Services installés] ; activez ensuite le service [VeraDesk Input]."),
        ...
        ("Language", "Langue"),
        ("Keep VeraDesk background service", "Garder le service VeraDesk en arrière plan"),
        ("Ignore Battery Optimizations", "Ignorer les optimisations de la batterie"),
        ("android_open_battery_optimizations_tip", "Pour désactiver cette fonctionnalité, veuillez accéder à la page suivante des paramètres de l’application VeraDesk, puis recherchez et accédez à la section [Batterie] ; décochez ensuite l’option [Sans restriction]."),
        ...
        ("Show VeraDesk", "Afficher VeraDesk"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Vous devez accorder à VeraDesk l’autorisation « Surveillance de l’entrée » pour contrôler le bureau distant avec le clavier."),
        ("config_microphone", "Vous devez accorder à VeraDesk l’autorisation « Enregistrer l’audio » pour discuter à distance."),
        ...
        ("still_click_uac_tip", "L’utilisateur distant devra malgré tout confirmer l’UAC de l’instance VeraDesk en cours d’éxécution."),
        ...
        ("View Mode", "Mode vue"),
        ("verify_veradesk_password_tip", "Vérifier le mot de passe VeraDesk"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu’un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N’AVEZ PAS CONFIANCE et qui vous a demandé d’utiliser VeraDesk et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Veuillez mettre à jour VeraDesk Server Pro vers la version {} ou une version ultérieure !"),
        ...
        ("selinux_tip", "SELinux est activé sur votre appareil, ce qui peut empêcher VeraDesk de fonctionner correctement sur la machine contrôlée."),
        ...
        ("powered_by_me", "Utilise la technologie VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "N’autoriser la connexion que si la fenêtre VeraDesk est ouverte"),
        ...
        ("About VeraDesk", "À propos de VeraDesk"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Veuillez mettre le client VeraDesk distant à jour vers la version {} ou ultérieure !"),
        ...
        ("allow-insecure-tls-fallback-tip", "Par défaut, VeraDesk vérifie le certificat du serveur lors de l’utilisation de protocoles utilisant TLS.\nLorsque cette option est activée, VeraDesk autorise les connexions même en cas d’échec de l’étape de vérification."),
        ("Disable UDP", "Désactiver UDP"),
        ("disable-udp-tip", "Contrôle l’utilisation exclusive du mode TCP.\nLorsque cette option est activée, VeraDesk n’utilise plus le port UDP 21116 et utilise le port TCP 21116 à la place."),
        ("server-oss-not-support-tip", "Note : Cette fonctionnalité n’est pas disponible sous la version open-source du serveur VeraDesk."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk ne peut pas accéder à la session de bureau de l'appareil distant, vérifiez qu'une session est ouverte et que VeraDesk peut l'utiliser"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk n'a pas pu obtenir d'écran exploitable auprès du XDG Desktop Portal, la bibliothèque PipeWire est peut-être trop ancienne"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk n'a pas pu charger un composant GStreamer nécessaire à la capture d'écran ({})"),
