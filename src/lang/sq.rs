...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Për shkak të UAC, VeraDesk nuk mund të punoj sic duhet si nje remote në distancë në disa raste. Për të shamngur UAC, ju lutem klikoni butonin më poshtë për të instaluar VeraDesk në sistem."),
        ("Click to upgrade", "Klikoni për përmirësim"),
        ("Configure", "Koniguro"),
        ("config_acc", "Për të kontrolluar Desktopin tuaj nga distanca, duhet të jepni leje VeraDesk \"Aksesueshmëri\"."),
        ("config_screen", "Për të aksesuar Desktopin tuaj nga distanca, duhet ti jepni lejet VeraDesk \"Regjistrimin e ekranit\"."),
        ...
        ("android_input_permission_tip1", "Në mënyrë që një pajisje në distancë të kontrollojë pajisjen tuaj Android nëpërmjet mausit ose prekjes, duhet të lejoni VeraDesk të përdorë shërbimin."),
        ("android_input_permission_tip2", "Ju lutemi shkoni në faqen tjetër të cilësimeve të sistemit, gjeni dhe shtypni [Shërbimet e Instaluara], aktivizoni shërbimin [VeraDesk Input]"),
        ...
        ("Turned off", "I fikur"),
        ("Language", "Gjuha"),
        ("Keep VeraDesk background service", "Mbaje shërbimin e sfondit të VeraDesk"),
        ("Ignore Battery Optimizations", "Injoro optimizimet e baterisë"),
        ("android_open_battery_optimizations_tip", "Nëse dëshironi ta çaktivizoni këtë veçori, ju lutemi shkoni te faqja tjetër e cilësimeve të aplikacionit VeraDesk, gjeni dhe shtypni [Batteri], hiqni zgjedhjen [Te pakufizuara]"),
        ...
        ("config_input", "Për të kontrolluar desktopin në distancë me tastierë, duhet t'i jepni VeraDesk lejen \"Monitorimi i hyrjes\"."),
        ("config_microphone", "Për të folur në distancë, duhet t'i jepni VeraDesk lejen \"Regjistro audio\"."),
        ...
        ("still_click_uac_tip", "Ende kërkon që përdoruesi në distancë të klikojë OK në dritaren UAC të VeraDesk që po funksionon."),
        ...
        ("verify_veradesk_password_tip", "Verifiko fjalëkalimin e VeraDesk"),
        ...
        ("scam_text1", "Nëse jeni në telefon me dikë që NUK e njihni DHE NUK i BESONI, i cili ju ka kërkuar të përdorni VeraDesk dhe të nisni shërbimin, mos vazhdoni dhe mbyllni telefonin menjëherë."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Ju lutemi përmirësoni VeraDesk Server Pro në versionin {} ose më të ri!"),
        ...
        ("selinux_tip", "SELinux është i aktivizuar në pajisjen tuaj, gjë që mund të pengojë VeraDesk të funksionojë siç duhet si anë e kontrolluar."),
        ...
        ("powered_by_me", "Mundësuar nga VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Lejo lidhjen vetëm nëse dritarja e VeraDesk është e hapur"),
        ...
        ("floating_window_tip", "Ndihmon për të mbajtur shërbimin në sfond të VeraDesk"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Ju lutemi përmirësoni klientin VeraDesk në versionin {} ose më të ri në anën në distancë!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Si parazgjedhje, VeraDesk verifikon certifikatën e serverit për protokollet që përdorin TLS.\nMe këtë opsion të aktivizuar, VeraDesk do të kthehet duke kapërcyer hapin e verifikimit dhe do të vazhdojë në rast dështimi të verifikimit."),
        ("Disable UDP", "Çaktivizo UDP"),
        ("disable-udp-tip", "Kontrollon nëse do të përdoret vetëm TCP.\nKur ky opsion është i aktivizuar, VeraDesk nuk do ta përdorë më UDP 21116, në vend të tij do të përdoret TCP 21116."),
        ("server-oss-not-support-tip", "SHËNIM: VeraDesk server OSS nuk e përfshin këtë veçori."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk nuk mund të arrijë sesionin e desktopit në pajisjen e largët, kontrolloni që një sesion desktopi po funksionon dhe që VeraDesk mund ta përdorë"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk nuk mori një ekran të përdorshëm nga XDG Desktop Portal, biblioteka PipeWire mund të jetë shumë e vjetër"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk nuk mundi të ngarkojë një komponent të GStreamer të nevojshëm për regjistrimin e ekranit ({})"),
