...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használatakor. A megfelelő működés érdekében, telepítse a VeraDesk alkalmazást a számítógépére."),
        ("Click to upgrade", "Kattintson ide a frissítés telepítéséhez"),
        ("Configure", "Beállítás"),
        ("config_acc", "A számítógép távoli vezérléséhez a VeraDesknek hozzáférési jogokat kell adnia."),
        ("config_screen", "Ahhoz, hogy távolról hozzáférhessen a számítógépéhez, meg kell adnia a VeraDesknek a „Képernyőfelvétel” jogosultságot."),
        ...
        ("android_input_permission_tip1", "Ahhoz, hogy egy távoli eszköz vezérelhesse Android készülékét, engedélyeznie kell a VeraDesk számára a „Hozzáférhetőség” szolgáltatás használatát."),
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a „VeraDesk Input” szolgáltatást."),
        ...
        ("Language", "Nyelv"),
        ("Keep VeraDesk background service", "VeraDesk futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívül hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a VeraDesk alkalmazás beállításaiba, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ...
        ("Show VeraDesk", "A VeraDesk megjelenítése"),
        ...
        ("config_input", "Ahhoz, hogy a távoli asztalt a billentyűzettel vezérelhesse, a VeraDesknek meg kell adnia a „Bemenet figyelése” jogosultságot."),
        ("config_microphone", "Ahhoz, hogy távolról beszélhessen, meg kell adnia a VeraDesknek a „Hangfelvétel” jogosultságot."),
        ...
        ("still_click_uac_tip", "A távoli felhasználónak továbbra is az „Igen” gombra kell kattintania a VeraDesk UAC ablakában. Kattintson!"),
        ...
        ("View Mode", "Nézet mód"),
        ("verify_veradesk_password_tip", "VeraDesk jelszó megerősítése"),
        ...
        ("scam_text1", "Ha olyan valakivel beszél telefonon, akit NEM ISMER, akiben NEM BÍZIK MEG, és aki arra kéri, hogy használja a VeraDesket és indítsa el a szolgáltatást, ne folytassa, és azonnal tegye le a telefont."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Frissítse a VeraDesk Server Prot a(z) {} vagy újabb verzióra!"),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a VeraDesk nem fut megfelelően, mint ellenőrzött."),
        ...
        ("powered_by_me", "Üzemeltető: VeraDesk"),
        ("outgoing_only_desk_tip", "Ez a VeraDesk testre szabott kimenete.\nMás eszközökhöz kapcsolódhat, de más eszközök nem kapcsolódhatnak az Ön eszközéhez."),
        ("preset_password_warning", "Ez egy testre szabott kimenet a VeraDeskből egy előre beállított jelszóval. Bárki, aki ismeri ezt a jelszót, teljes irányítást szerezhet a készülék felett. Ha nem kívánja ezt megtenni, azonnal távolítsa el ezt a szoftvert."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a kapcsolódást, ha a VeraDesk ablaka nyitva van."),
        ...
        ("floating_window_tip", "Segít, ha a VeraDesk a háttérben fut."),
        ...
        ("About VeraDesk", "A VeraDesk névjegye"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Frissítse a VeraDesk klienst {} vagy újabb verziójára a távoli oldalon!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Alapértelmezés szerint a VeraDesk ellenőrzi a kiszolgáló tanúsítványát a TLS-protokollok esetében. Ha ez a beállítás engedélyezve van, a VeraDesk kihagyja az ellenőrzési lépést, és az ellenőrzés sikertelensége esetén folytatja a műveletet."),
        ("Disable UDP", "UDP letiltása"),
        ("disable-udp-tip", "Meghatározza, hogy csak TCP-t használjon-e. Ha ez az beállítás engedélyezve van, a VeraDesk nem fogja többé használni a 21116-os UDP-portot, helyette a 21116-os TCP-portot fogja használni."),
        ("server-oss-not-support-tip", "MEGJEGYZÉS: Az OSS VeraDesk kiszolgáló nem támogatja ezt a funkciót."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "A VeraDesk nem éri el az asztali munkamenetet a távoli eszközön, ellenőrizze, hogy fut-e munkamenet és hogy a VeraDesk használhatja-e"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "A VeraDesk nem kapott használható képernyőt az XDG Desktop Portaltól, a PipeWire programkönyvtár túl régi lehet"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "A VeraDesk nem tudta betölteni a képernyőrögzítéshez szükséges GStreamer összetevőt ({})"),
