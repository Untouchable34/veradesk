...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do VeraDesk..."),
        ...
        ("install_tip", "Devido ao UAC, o VeraDesk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o VeraDesk no sistema."),
        ("Click to upgrade", "Iniciar atualização"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao VeraDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao VeraDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o VeraDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [VeraDesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep VeraDesk background service", "Manter o serviço do VeraDesk executando em segundo plano"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do VeraDesk."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do VeraDesk."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do VeraDesk."),
        ...
        ("verify_veradesk_password_tip", "Verifique a senha do VeraDesk"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o VeraDesk e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Atualize o VeraDesk Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o VeraDesk funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do VeraDesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço VeraDesk em segundo plano"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Atualize o cliente VeraDesk para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o VeraDesk verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o VeraDesk ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o VeraDesk não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ("server-oss-not-support-tip", "NOTA: O servidor VeraDesk OSS não inclui este recurso."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "O VeraDesk não consegue acessar a sessão da área de trabalho no dispositivo remoto, verifique se há uma sessão da área de trabalho em execução e se o VeraDesk pode acessá-la."),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "O VeraDesk não conseguiu obter uma tela utilizável do XDG Desktop Portal. A biblioteca do PipeWire pode estar desatualizada."),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "O VeraDesk não conseguiu carregar um componente do GStreamer necessário para a captura de tela ({})."),
