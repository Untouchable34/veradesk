...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Дайын"),
        ("Established", "Қосылды"),
        ("connecting_status", "VeraDesk желісіне қосылуда..."),
        ...
        ("install_tip", "UAC кесірінен, VeraDesk кейбірде қашықтағы жақ ретінде дұрыс жұмыс істей алмайды. UAC'пен қиындықты болдырмау үшін, төмендегі батырманы басып VeraDesk'ті жүйеге орнатыңыз."),
        ("Click to upgrade", "Жаңғырту үшін басыңыз"),
        ("Configure", "Қалыптау"),
        ("config_acc", "Сіздің Жұмыс үстеліңізді қашықтан басқару үшін, VeraDesk'ке \"Қолжетімділік\" рұқсаттарын беруіңіз керек."),
        ("config_screen", "Сіздің Жұмыс үстеліңізге қашықтан қол жеткізу үшін, VeraDesk'ке \"Екіренді Жазу\" рұқсаттарын беруіңіз керек."),
        ("Installing ...", "Орнатылу..."),
        ("Install", "Орнату"),
        ...
        ("android_input_permission_tip1", "Қашықтағы құрылғы сіздің Android құрылғыңызды тінтуір немесе түрту арқылы басқару үшін, VeraDesk'ке \"Қолжетімділік\" сербесін қолдануға рұқсат беруініз керек."),
        ("android_input_permission_tip2", "Келесі Жүйе Орнатпалары бетіне барып, [Орнатылған Сербестер]'ді тауып кіріңіз, сосын [VeraDesk Еңгізу] сербесін іске қосыңыз."),
        ...
        ("Language", "Тіл"),
        ("Keep VeraDesk background service", "Артжақтағы VeraDesk сербесін сақтап тұру"),
        ("Ignore Battery Optimizations", "Бәтері Оңтайландыруларын Елемеу"),
        ("android_open_battery_optimizations_tip", "Егер де бұл ерекшелікті өшіруді қаласаңыз, келесі VeraDesk апылқат орнатпалары бетіне барып, [Бәтері]'ні тауып кіріңіз де [Шектеусіз]'ден құсбелгіні алып тастауды өтінеміз"),
        ...
        ("Show VeraDesk", "VeraDesk'ті көрсету"),
        ("This PC", "Бұл ДК"),
        ("or", "немесе"),
        ...
        ("config_input", "Қашықтағы жұмыс үстелін пернетақтамен басқару үшін, VeraDesk'ке \"Еңгізуді Қадағалау\" рұқсаттарын беруіңіз керек."),
        ("config_microphone", "Қашықтан сөйлесу үшін, VeraDesk'ке \"Аудио Жазу\" рұқсаттарын беруіңіз керек."),
        ...
        ("still_click_uac_tip", "Қашықтағы қолданушыдан VeraDesk іске қосылған UAC терезесінде OK басуды әлі де талап етеді."),
        ...
        ("verify_veradesk_password_tip", "VeraDesk құпия сөзін тексеру"),
        ...
        ("scam_text1", "Егер сіз танымайтын ЖӘНЕ СЕНБЕЙТІН біреумен телефонмен сөйлесіп жатсаңыз және ол сізден VeraDesk қолданып, сербесті іске қосуды сұраса, жалғастырмаңыз да дереу телефонды қойыңыз."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "VeraDesk Server Pro'ны {} немесе одан жаңа нұсқаға жаңартуды өтінеміз!"),
        ...
        ("selinux_tip", "Сіздің құрылғыңызда SELinux қосылған, бұл VeraDesk'тің басқарылатын жақ ретінде дұрыс жұмыс істеуіне кедергі келтіруі мүмкін."),
        ...
        ("powered_by_me", "VeraDesk негізінде"),
        ...
        ("allow-only-conn-window-open-tip", "Тек VeraDesk терезесі ашық болғанда ғана қосылымға рұқсат ету"),
        ...
        ("floating_window_tip", "Ол VeraDesk артжақ сербесін сақтап тұруға көмектеседі"),
        ...
        ("About VeraDesk", "VeraDesk туралы"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Қашықтағы жақтағы VeraDesk клиентін {} немесе одан жоғары нұсқаға жаңартуды өтінеміз!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Әдепкіде VeraDesk TLS қолданатын протоколдар үшін сербер сертификатын тексереді.\nБұл опция қосылғанда, VeraDesk тексеру сәтсіз болған жағдайда тексеру қадамын өткізіп жіберуге қайтып, жалғастырады."),
        ("Disable UDP", "UDP-ні өшіру"),
        ("disable-udp-tip", "Тек TCP қолданатынын-қолданбайтынын басқарады.\nБұл опция қосылғанда, VeraDesk енді UDP 21116 қолданбайды, оның орнына TCP 21116 қолданылады."),
        ("server-oss-not-support-tip", "ЕСКЕРТПЕ: VeraDesk server OSS бұл ерекшелікті қамтымайды."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk қашықтағы құрылғының жұмыс үстелі сеансына қол жеткізе алмайды, сеанстың іске қосылғанын және VeraDesk оны пайдалана алатынын тексеріңіз"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk XDG Desktop Portal-дан жарамды экран ала алмады, PipeWire кітапханасы тым ескі болуы мүмкін"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk экранды түсіру үшін қажет GStreamer компонентін жүктей алмады ({})"),
