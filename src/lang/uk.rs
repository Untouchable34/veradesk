...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі VeraDesk..."),
        ...
        ("install_tip", "Через UAC, в деяких випадках VeraDesk може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення VeraDesk в системі"),
        ("Click to upgrade", "Натисніть, щоб перевірити наявність оновлень"),
        ("Configure", "Налаштувати"),
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати VeraDesk дозволи \"Спеціальні можливості\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці, вам необхідно надати VeraDesk дозволи на \"Запис екрана\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або дотику, вам необхідно дозволити VeraDesk використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Будь ласка, перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [VeraDesk Input]."),
        ...
        ("Language", "Мова"),
        ("Keep VeraDesk background service", "Зберегти фонову службу VeraDesk"),
        ...
        ("Show VeraDesk", "Показати VeraDesk"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("config_input", "Для віддаленого керування віддаленою стільницею з клавіатури, вам необхідно надати VeraDesk дозволи на \"Відстеження введення\""),
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати VeraDesk дозвіл на \"Запис аудіо\""),
        ...
        ("verify_veradesk_password_tip", "Перевірте пароль VeraDesk"),
        ...
        ("scam_text1", "Якщо ви розмовляєте по телефону з кимось, кого НЕ ЗНАЄТЕ чи кому НЕ ДОВІРЯЄТЕ, і ця особа хоче, щоб ви використали VeraDesk та запустили службу, не робіть цього та негайно завершіть дзвінок."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Будь ласка, оновіть VeraDesk Server Pro до версії {} чи новіше!"),
        ...
        ("selinux_tip", "SELinux увімкнено на вашому пристрої, що може ускладнити для іншої сторони віддалене керування за допомогою VeraDesk."),
        ...
        ("powered_by_me", "На основі Veradesk"),
        ...
        ("allow-only-conn-window-open-tip", "Дозволяти підключення лише коли відкрите вікно VeraDesk"),
        ...
        ("floating_window_tip", "Допомагає зберегти фонову службу Veradesk"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Будь ласка, оновіть VeraDesk клієнт на віддаленому пристрої до версії {} чи новіше!"),
        ...
        ("allow-insecure-tls-fallback-tip", "За замовчуванням VeraDesk перевіряє сертифікат сервера для протоколів, які використовують TLS.\nКоли цей параметр увімкнено, у разі помилки перевірки VeraDesk пропустить крок перевірки та продовжить."),
        ("Disable UDP", "Вимкнути UDP"),
        ("disable-udp-tip", "Визначає, чи використовувати лише TCP.\nКоли цей параметр увімкнено, VeraDesk більше не використовуватиме UDP 21116, замість нього буде використано TCP 21116."),
        ("server-oss-not-support-tip", "ПРИМІТКА: сервер VeraDesk OSS не містить цієї функції."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk не може отримати доступ до сеансу стільниці на віддаленому пристрої, перевірте, чи запущено сеанс і чи може VeraDesk його використовувати"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk не зміг отримати придатний екран від XDG Desktop Portal, бібліотека PipeWire може бути застарою"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk не вдалося завантажити компонент GStreamer, потрібний для захоплення екрана ({})"),
