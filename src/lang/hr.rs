...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na VeraDesk mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a VeraDesk ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate VeraDesk na sustav."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfiguracija"),
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, VeraDesk-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, VeraDesk-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti VeraDesk-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [VeraDesk Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep VeraDesk background service", "Zadrži VeraDesk kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje VeraDesk aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show VeraDesk", "Prikaži VeraDesk"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti VeraDesku dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti VeraDesku \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog VeraDeska."),
        ...
        ("verify_veradesk_password_tip", "Provjera lozinke za VeraDesk"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete VeraDesk, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Ažurirajte VeraDesk Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti VeraDesk da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dopusti vezu samo ako je prozor VeraDeska otvoren"),
        ...
        ("floating_window_tip", "Pomaže u održavanju pozadinskog servisa VeraDeska"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Molimo ažurirajte VeraDesk klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Prema zadanim postavkama, VeraDesk provjerava certifikat poslužitelja za protokole koji koriste TLS.\nKada je ova opcija omogućena, VeraDesk će u slučaju neuspjele provjere preskočiti korak provjere i nastaviti."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Određuje hoće li se koristiti samo TCP.\nKada je ova opcija omogućena, VeraDesk više neće koristiti UDP 21116, već će umjesto toga koristiti TCP 21116."),
        ("server-oss-not-support-tip", "NAPOMENA: VeraDesk poslužitelj OSS ne uključuje ovu značajku."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk ne može pristupiti sesiji radne površine na udaljenom uređaju, provjerite radi li sesija i može li je VeraDesk koristiti"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk nije mogao dobiti upotrebljiv zaslon od XDG Desktop Portala, PipeWire biblioteka je možda prestara"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk nije mogao učitati GStreamer komponentu potrebnu za snimanje zaslona ({})"),
