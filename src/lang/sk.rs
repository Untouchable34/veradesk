...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Pripájam sa na VeraDesk server..."),
        ...
        ("install_tip", "V niektorých prípadoch VeraDesk nefunguje správne z dôvodu riadenia užívateľských oprávnení (UAC). Vyhnete sa tomu kliknutím na nižšie zobrazene tlačítko a nainštalovaním RuskDesk do systému."),
        ("Click to upgrade", "Kliknutím nainštalujete aktualizáciu"),
        ("Configure", "Nastaviť"),
        ("config_acc", "Aby bolo možné na diaľku ovládať vašu plochu, je potrebné aplikácii VeraDesk udeliť práva \"Dostupnosť\"."),
        ("config_screen", "Aby bolo možné na diaľku sledovať vašu obrazovku, je potrebné aplikácii VeraDesk udeliť práva \"Zachytávanie obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby bolo možné na diaľku ovládať vašu plochu pomocou myši alebo dotykov, je potrebné aplikácii VeraDesk udeliť práva \"Dostupnosť\"."),
        ("android_input_permission_tip2", "Prejdite na stránku nastavení systému, nájdite a vstúpte do [Stiahnuté služby], zapnite [VeraDesk Input] službu."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep VeraDesk background service", "Ponechať službu VeraDesk na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovať optimalizácie batérie"),
        ("android_open_battery_optimizations_tip", "Ak chcete túto funkciu vypnúť, prejdite na ďalšiu stránku nastavení VeraDesku, vyhľadajte a zadajte položku [Batéria], zrušte začiarknutie položky [Neobmedzené]."),
        ...
        ("Show VeraDesk", "Zobraziť VeraDesk"),
        ...
        ("config_input", "Ak chcete ovládať vzdialenú plochu pomocou klávesnice, musíte udeliť oprávnenie VeraDesk \"Sledovanie vstupu\"."),
        ("config_microphone", "Ak chcete hovoriť na diaľku, musíte VeraDesku udeliť povolenie \"Nahrávať zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále sa vyžaduje, aby vzdialený používateľ klikol na tlačidlo OK v okne UAC spusteného programu VeraDesk."),
        ...
        ("verify_veradesk_password_tip", "Overenie hesla VeraDesk"),
        ...
        ("scam_text1", "Ak telefonujete s niekým, koho nepoznáte a komu nedôverujete a kto vás požiadal o použitie a spustenie aplikácie VeraDesk, nepokračujte v hovore a okamžite zaveste."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Aktualizujte VeraDesk Server Pro na verziu {} alebo novšiu!"),
        ...
        ("selinux_tip", "Na vašom zariadení je povolený SELinux, čo môže brániť správnemu spusteniu VeraDesku ako spravovanej strany."),
        ...
        ("powered_by_me", "Poháňané aplikáciou VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Povoliť pripojenie iba vtedy, ak je otvorené okno aplikácie VeraDesk"),
        ...
        ("floating_window_tip", "Pomáha udržiavať službu VeraDesk na pozadí"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Aktualizujte klienta VeraDesk na verziu {} alebo novšiu na vzdialenej strane!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Štandardne VeraDesk overuje certifikát servera pre protokoly používajúce TLS.\nS touto možnosťou VeraDesk v prípade zlyhania overenia preskočí krok overovania a bude pokračovať."),
        ("Disable UDP", "Vypnúť UDP"),
        ("disable-udp-tip", "Určuje, či sa má používať iba TCP.\nKeď je táto možnosť povolená, VeraDesk už nebude používať UDP 21116, namiesto neho sa použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: VeraDesk server OSS túto funkciu neobsahuje."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk nemá prístup k relácii plochy na vzdialenom zariadení, overte, či relácia beží a či ju VeraDesk môže použiť"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk nezískal z XDG Desktop Portal použiteľnú obrazovku, knižnica PipeWire môže byť príliš stará"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk nedokázal načítať komponent GStreamera potrebný na zachytenie obrazovky ({})"),
