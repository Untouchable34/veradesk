...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "VeraDeski võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa VeraDesk mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et VeraDesk oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb VeraDeskile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb VeraDeskile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma VeraDeskile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [VeraDesk Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep VeraDesk background service", "Säilita VeraDeski taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele VeraDeski rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma VeraDeskile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma VeraDeskile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud VeraDeski kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_veradesk_password_tip", "Kinnita VeraDeski parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul VeraDeski kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Palun täienda VeraDesk Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib VeraDeskil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb VeraDeskil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui VeraDeski aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada VeraDeski taustateenust."),
        ...
        ("About VeraDesk", "VeraDeski teave"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Täiendage VeraDeski klient kaugküljel versioonile {} või uuemale!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib VeraDesk TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab VeraDesk kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta VeraDesk enam UDP 21116, vaid kasutatakse selle asemel TCP 21116."),
        ("server-oss-not-support-tip", "MÄRKUS: VeraDeski serveri OSS ei sisalda seda funktsiooni."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk ei pääse kaugseadmes töölauaseansini, kontrollige, kas seanss töötab ja kas VeraDesk saab seda kasutada"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk ei saanud XDG Desktop Portalilt kasutatavat ekraani, PipeWire'i teek võib olla liiga vana"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk ei suutnud laadida ekraani jäädvustamiseks vajalikku GStreameri komponenti ({})"),
