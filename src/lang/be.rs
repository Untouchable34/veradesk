...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ідзе падключэнне да сеткі VeraDesk..."),
        ...
        ("install_tip", "У некаторых выпадках з-за UAC, VeraDesk можа працаваць на баку абанента неадпаведным чынам. Каб пазбегнуць магчымых праблем з UAC, націсніце кнопку ніжэй для ўсталявання VeraDesk у сістэме."),
        ("Click to upgrade", "Абнавіць"),
        ("Configure", "Наладзіць"),
        ("config_acc", "Каб аддаленна кіраваць сваім працоўным сталом, вам трэба дазволіць VeraDesk правы \"доступу\""),
        ("config_screen", "Для аддаленага доступу да працоўнага стала вам трэба даць VeraDesk правы \"здымку экрана\"."),
        ...
        ("android_input_permission_tip1", "Каб аддаленая прылада магла кіраваць вашай Android-прыладай з дапамогай мышы або націсканняў, трэба дазволіць VeraDesk выкарыстоўваць службу \"Спецыяльныя магчымасці\"."),
        ("android_input_permission_tip2", "Зайдзіце на адпаведную старонку сістэмных налад, знайдзіце і перайдзіце ва \"Усталяваныя службы\", уключыце службу \"VeraDesk Input\"."),
        ...
        ("Language", "Мова"),
        ("Keep VeraDesk background service", "Захаваць фонавую службу VeraDesk"),
        ...
        ("Show VeraDesk", "Паказаць VeraDesk"),
        ...
        ("config_input", "Каб кіраваць аддаленым працоўным сталом праз клавіятуру, трэба дазволіць VeraDesk \"Маніторынг уводу\"."),
        ("config_microphone", "Каб размаўляць з абанентам, трэба дазволіць VeraDesk запіс аўдыя."),
        ...
        ("still_click_uac_tip", "Дагэтуль патрэбна, каб абанент націснуў \"OK\" ў акне UAC пры запуску VeraDesk."),
        ...
        ("verify_veradesk_password_tip", "Пацвердзіць пароль VeraDesk"),
        ...
        ("scam_text1", "Калі вы размаўляеце па тэлефоне з кімсьці НЕЗНАЁМЫМ і каму вы НЕ ДАВЕРАЕЦЕ, і гэта асоба просіць вас выкарыстаць VeraDesk і запусціць яго службу, не працягвайце і неадкладна скончыце размову."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Абнавіце VeraDesk Server Pro да версіі {} або навейшай!"),
        ...
        ("selinux_tip", "На вашай прыладзе ўключаны SELinux, што можа ствараць перашкоды ў працы VeraDesk на баку абанента."),
        ("Change view", "Рэжым"),
        ...
        ("powered_by_me", "Заснавана на VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Дазволіць падключэнне толькі пры адкрытым акне VeraDesk"),
        ...
        ("floating_window_tip", "Дапамагае падтрымліваць фонавую службу VeraDesk"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Абнавіце кліент VeraDesk да версіі {} або навейшай на баку абанента!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Стандартна VeraDesk правярае сертыфікат сервера на наяўнасць пратаколаў, якія выкарыстоўваюць TLS.\nКалі гэта функцыя ўключана, VeraDesk прапусціць дадзены этап і працягне працу ў выпадку няўдалай праверкі."),
        ("Disable UDP", "Выключыць UDP"),
        ("disable-udp-tip", "Вызначае, ці варта выкарыстоўваць толькі TCP.\nКалі ўключана, VeraDesk не будзе выкарыстоўваць UDP 21116, замест чаго будзе выкарыстоўвацца TCP 21116."),
        ("server-oss-not-support-tip", "ЗАЎВАГА! у OSS-серверы VeraDesk гэта функцыя адсутнічае."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk не можа атрымаць доступ да сеанса працоўнага стала на аддаленай прыладзе, праверце, ці запушчаны сеанс і ці даступны ён для VeraDesk"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk не змог атрымаць прыдатны экран ад XDG Desktop Portal, магчыма бібліятэка PipeWire занадта старая"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk не змог загрузіць кампанент GStreamer, патрэбны для захопу экрана ({})"),
