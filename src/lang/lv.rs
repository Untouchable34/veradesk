...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Notiek savienojuma izveide ar VeraDesk tīklu..."),
        ...
        ("install_tip", "UAC dēļ VeraDesk dažos gadījumos nevar pareizi darboties kā attālā puse. Lai izvairītos no UAC, lūdzu, noklikšķiniet uz tālāk esošās pogas, lai instalētu VeraDesk sistēmā."),
        ("Click to upgrade", "Jaunināt"),
        ("Configure", "Konfigurēt"),
        ("config_acc", "Lai attālināti vadītu savu darbvirsmu, jums ir jāpiešķir VeraDesk \"Pieejamība\" atļaujas."),
        ("config_screen", "Lai attālināti piekļūtu darbvirsmai, jums ir jāpiešķir VeraDesk \"Ekrāna tveršana\" atļaujas."),
        ...
        ("android_input_permission_tip1", "Lai attālā ierīce varētu vadīt jūsu Android ierīci, izmantojot peli vai pieskārienu, jums ir jāatļauj VeraDesk izmantot servisu \"Pieejamība\"."),
        ("android_input_permission_tip2", "Lūdzu, dodieties uz nākamo sistēmas iestatījumu lapu, atrodiet un atveriet [Instalētie pakalpojumi], ieslēdziet servisu [VeraDesk Input]."),
        ...
        ("Turned off", "Izslēgts"),
        ("Language", "Valoda"),
        ("Keep VeraDesk background service", "Saglabāt VeraDesk fona servisu"),
        ("Ignore Battery Optimizations", "Ignorēt akumulatora optimizāciju"),
        ("android_open_battery_optimizations_tip", "Ja vēlaties atspējot šo funkciju, lūdzu, dodieties uz nākamo VeraDesk lietojumprogrammas iestatījumu lapu, atrodiet un atveriet [Akumulators], noņemiet atzīmi no [Neierobežots]"),
        ...
        ("config_input", "Lai vadītu attālo darbvirsmu ar tastatūru, jums ir jāpiešķir VeraDesk \"Ievades uzraudzība\" atļaujas."),
        ("config_microphone", "Lai runātu attālināti, jums ir jāpiešķir VeraDesk \"Ierakstīt audio\" atļaujas."),
        ...
        ("still_click_uac_tip", "Joprojām attālajam lietotājam ir jānoklikšķina uz Labi UAC logā, kurā darbojas VeraDesk."),
        ...
        ("verify_veradesk_password_tip", "Pārbaudīt VeraDesk paroli"),
        ...
        ("scam_text1", "Ja sarunājaties ar kādu, kuru nepazīstat un kurš ir lūdzis izmantot VeraDesk, lai sāktu pakalpojumu, neturpiniet un nekavējoties nolieciet klausuli."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Lūdzu, jauniniet VeraDesk Server Pro uz versiju {} vai jaunāku!"),
        ...
        ("selinux_tip", "Jūsu ierīcē ir iespējots SELinux, kas var neļaut VeraDesk pareizi darboties kā kontrolētajai pusei."),
        ...
        ("powered_by_me", "Darbojas ar VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Atļaut savienojumu tikai tad, ja ir atvērts VeraDesk logs"),
        ...
        ("floating_window_tip", "Tas palīdz uzturēt VeraDesk fona servisu"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Lūdzu, jauniniet attālās puses VeraDesk klientu uz versiju {} vai jaunāku!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Pēc noklusējuma VeraDesk pārbauda servera sertifikātu protokoliem, izmantojot TLS.\nJa šī opcija ir iespējota, VeraDesk izlaidīs verifikācijas soli un turpinās darbību verifikācijas kļūmes gadījumā."),
        ("Disable UDP", "Atspējot UDP"),
        ("disable-udp-tip", "Nosaka, vai izmantot tikai TCP.\nKad šī opcija ir iespējota, VeraDesk vairs neizmantos UDP 21116, tā vietā tiks izmantots TCP 21116."),
        ("server-oss-not-support-tip", "PIEZĪME. VeraDesk servera OSS neietver šo funkciju."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk nevar piekļūt attālinātās ierīces darbvirsmas sesijai, pārbaudiet, vai sesija darbojas un vai VeraDesk to var izmantot"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk neieguva izmantojamu ekrānu no XDG Desktop Portal, PipeWire bibliotēka var būt pārāk veca"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk nevarēja ielādēt ekrāna tveršanai nepieciešamo GStreamer komponentu ({})"),
