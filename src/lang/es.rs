...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red VeraDesk en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que VeraDesk no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar VeraDesk a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a VeraDesk de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a VeraDesk de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que VeraDesk use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [VeraDesk Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep VeraDesk background service", "Dejar VeraDesk como Servicio en 2do plano"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a VeraDesk permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a VeraDesk permisos de \"Grabar Audio\"."),
        ...
        ("verify_veradesk_password_tip", "Verificar la contraseña de VeraDesk"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses VeraDesk e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "¡Por favor, actualiza VeraDesk Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que VeraDesk no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de VeraDesk"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de VeraDesk de fondo"),
        ...
        ("About VeraDesk", "Acerca de VeraDesk"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Por favor, actualiza el cliente VeraDesk a la versión {} o superior en el lado remoto"),
        ...
        ("allow-insecure-tls-fallback-tip", "De forma predeterminada, VeraDesk verifica el certificado de servidor para protocolos que usen TLS.\nCon esta opción habilitada, Veradesk volverá al paso de omisión de verificación y procederá en caso de fallo de verificación."),
        ("Disable UDP", "Inhabilitar UDP"),
        ("disable-udp-tip", "Controla si se usa TCP solamente.\nCuando esta opción está activa, VeraDesk no usará más el puerto UDP 21116, en su lugar se usará el TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: El servidor VeraDesk OSS no incluye esta característica."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk no puede acceder a la sesión de escritorio del dispositivo remoto; compruebe que hay una sesión en marcha y que VeraDesk puede usarla"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk no ha podido obtener una pantalla utilizable del XDG Desktop Portal; la biblioteca PipeWire puede ser demasiado antigua"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk no ha podido cargar un componente de GStreamer necesario para capturar la pantalla ({})"),
