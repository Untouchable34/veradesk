...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem VeraDesk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, VeraDesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate VeraDesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate VeraDesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno VeraDesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »VeraDesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep VeraDesk background service", "Ohrani VeraDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije VeraDesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "VeraDesk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "VeraDesk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_veradesk_password_tip", "Preveri geslo za VeraDesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite VeraDesk, prekinite klic in program zaprite."),
        ("scam_text2", "VeraDesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Prosimo, nadgradite VeraDesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno VeraDeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri VeraDesk storitvi v ozadju"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Prosimo, nadgradite VeraDesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto VeraDesk preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo VeraDesk ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, VeraDesk ne bo več uporabljal UDP 21116, namesto tega bo uporabljen TCP 21116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik VeraDesk OSS ne vključuje te funkcije."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk ne more dostopati do namizne seje na oddaljeni napravi, preverite, ali seja teče in ali jo VeraDesk lahko uporablja"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk od XDG Desktop Portala ni dobil uporabnega zaslona, knjižnica PipeWire je morda prestara"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk ni mogel naložiti komponente GStreamer, potrebne za zajem zaslona ({})"),
