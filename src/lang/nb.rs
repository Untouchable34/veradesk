...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter tilkobling til VeraDesk-nettverket..."),
        ...
        ("install_tip", "På grunn av UAC kan VeraDesk ikke fungere korrekt i enkelte tillfeller på fjernskrivebordet. For å unngå UAC klikker du på knappen nedenfor for å installere VeraDesk på systemet"),
        ("Click to upgrade", "Klikk for å oppgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For å kontrollere ditt skrivebord med fjernstyring må du gi VeraDesk \"Access \" Rettigheter."),
        ("config_screen", "For å kunne få adgang til ditt skrivebord med fjernstyring, må du gi VeraDesk \"skjerstøtte \" tillatelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller berøring, må du gi VeraDesk mulighet til å bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "Gå til den neste systeminnstillingssiden, søk og tast inn [installerte tjenester], aktiver [VeraDesk Input] tjenesten."),
        ...
        ("android_open_battery_optimizations_tip", "Hvis du vil deaktivere denne funksjonen, gå til neste innstillingsside for VeraDesk-applikasjonen, finn og åpne [Batteri], og fjern haken ved [Ubegrenset]."),
        ...
        ("config_input", "For å kunne styre fjernskrivebordet med tastatur må du gi VeraDesk tillatelsen \"Inndataovervåking\"."),
        ("config_microphone", "For å kunne snakke eksternt må du gi VeraDesk tillatelsen \"Ta opp lyd\"."),
        ...
        ("still_click_uac_tip", "Krever fortsatt at fjernbrukeren klikker OK på UAC-vinduet til den kjørende VeraDesk."),
        ...
        ("verify_veradesk_password_tip", "Verifiser VeraDesk-passord"),
        ...
        ("scam_text1", "Hvis du snakker i telefonen med noen du IKKE kjenner OG STOLER PÅ, som har bedt deg om å bruke VeraDesk og starte tjenesten, ikke fortsett og legg på umiddelbart."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Vennligst oppgrader VeraDesk Server Pro til versjon {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktivert på enheten din, noe som kan hindre VeraDesk i å fungere som det skal på den kontrollerte siden."),
        ...
        ("powered_by_me", "Drevet av VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Tillat kun tilkobling hvis VeraDesk-vinduet er åpent"),
        ...
        ("floating_window_tip", "Det bidrar til å holde VeraDesk-bakgrunnstjenesten i gang"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Vennligst oppgrader VeraDesk-klienten til versjon {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifiserer VeraDesk serversertifikatet for protokoller som bruker TLS.\nMed dette alternativet aktivert vil VeraDesk falle tilbake til å hoppe over verifiseringstrinnet og fortsette ved verifiseringsfeil."),
        ("Disable UDP", "Deaktiver UDP"),
        ("disable-udp-tip", "Styrer om kun TCP skal brukes.\nNår dette alternativet er aktivert, vil VeraDesk ikke lenger bruke UDP 21116, TCP 21116 brukes i stedet."),
        ("server-oss-not-support-tip", "MERK: VeraDesk server OSS inkluderer ikke denne funksjonen."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk får ikke tilgang til skrivebordsøkten på den eksterne enheten, kontroller at en økt kjører og at VeraDesk kan bruke den"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk fikk ingen brukbar skjerm fra XDG Desktop Portal, PipeWire-biblioteket kan være for gammelt"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk kunne ikke laste en GStreamer-komponent som kreves for skjermopptak ({})"),
