...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới VeraDesk..."),
        ...
        ("install_tip", "Do cơ chế UAC, VeraDesk có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt VeraDesk vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho VeraDesk."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho VeraDesk."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [VeraDesk Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep VeraDesk background service", "Giữ dịch vụ VeraDesk chạy nền"),
        ...
        ("verify_veradesk_password_tip", "Xác thực mật khẩu VeraDesk"),
        ...
        ("scam_text2", "Chỉ sử dụng VeraDesk với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ VeraDesk mở"),
        ...
        ("floating_window_tip", "Giữ VeraDesk trên cùng"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk không thể truy cập phiên màn hình nền trên thiết bị từ xa, hãy kiểm tra rằng một phiên đang chạy và VeraDesk có thể dùng nó"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk không lấy được màn hình dùng được từ XDG Desktop Portal, thư viện PipeWire có thể quá cũ"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk không thể tải một thành phần GStreamer cần cho việc ghi màn hình ({})"),
