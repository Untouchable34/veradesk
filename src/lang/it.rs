...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete VeraDesk..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), VeraDesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare VeraDesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a VeraDesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a VeraDesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a VeraDesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [VeraDesk Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep VeraDesk background service", "Mantieni il servizio di VeraDesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione VeraDesk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show VeraDesk", "Visualizza VeraDesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a VeraDesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a VeraDesk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di VeraDesk."),
        ...
        ("verify_veradesk_password_tip", "Conferma password VeraDesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare VeraDesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Aggiorna VeraDesk Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di VeraDesk come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra VeraDesk è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio Veradesk in background."),
        ...
        ("About VeraDesk", "Info su VeraDesk"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Aggiorna il client VeraDesk remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, VeraDesk verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, VeraDesk salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, VeraDesk non userà più UDP 21116, verrà invece usato TCP 21116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server VeraDesk non include questa funzionalità."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk non riesce a raggiungere la sessione desktop nel dispositivo remoto, controlla che sia in esecuzione una sessione desktop e che VeraDesk possa usarla"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk non è riuscito a ottenere una schermata usabile dal portale desktop XDG, la libreria PipeWire potrebbe essere troppo vecchia"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk non è riuscito a caricare un componente GStreamer necessario per l'acquisizione dello schermo ({})"),
