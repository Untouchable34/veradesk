...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة VeraDesk..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. VeraDesk قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت VeraDesk في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح VeraDesk اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح VeraDesk اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ VeraDesk باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [VeraDesk Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep VeraDesk background service", "ابق خدمة VeraDesk تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق VeraDesk, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من VeraDesk اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح VeraDesk اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في VeraDesk الذي يعمل."),
        ...
        ("View Mode", "وضع العرض"),
        ("verify_veradesk_password_tip", "تحقق من كلمة مرور VeraDesk"),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "ترقية خادم VeraDesk Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع VeraDesk"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "ترقية عميل VeraDesk البعيد إلى {}"),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "يتعذّر على VeraDesk الوصول إلى جلسة سطح المكتب على الجهاز البعيد، تأكد من أن جلسة سطح المكتب تعمل وأن VeraDesk يمكنه استخدامها"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "تعذّر على VeraDesk الحصول على شاشة قابلة للاستخدام من XDG Desktop Portal، قد تكون مكتبة PipeWire قديمة جدًا"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "تعذّر على VeraDesk تحميل مكوّن GStreamer اللازم لالتقاط الشاشة ({})"),
