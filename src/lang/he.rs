...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "מוכן"),
        ("Established", "מחובר"),
        ("connecting_status", "מתחבר לרשת VeraDesk..."),
        ...
        ("install_tip", "בגלל UAC, VeraDesk לא יכול לפעול כראוי כצד מרוחק בחלק מהמקרים. כדי להימנע מ-UAC, אנא לחץ על הכפתור למטה כדי להתקין את VeraDesk במערכת."),
        ("Click to upgrade", "לחץ כדי לשדרג"),
        ("Configure", "הגדר"),
        ("config_acc", "כדי לשלוט מרחוק בשולחן העבודה שלך, עליך להעניק ל-VeraDesk הרשאות \"נגישות\"."),
        ("config_screen", "כדי לגשת מרחוק לשולחן העבודה שלך, עליך להעניק ל-VeraDesk הרשאות \"הקלטת מסך\"."),
        ("Installing ...", "מתקין ..."),
        ("Install", "התקן"),
        ("Installation", "התקנה"),
        ...
        ("android_input_permission_tip1", "כדי שמכשיר מרוחק יוכל לשלוט במכשיר האנדרואיד שלך באמצעות עכבר או מגע, עליך לאפשר ל-VeraDesk להשתמש בשירות \"נגישות\"."),
        ("android_input_permission_tip2", "אנא עבור לדף הגדרות המערכת הבא, מצא והכנס ל[שירותים מותקנים], הפעל את שירות [VeraDesk Input]."),
        ...
        ("Turned off", "מכובה"),
        ("Language", "שפה"),
        ("Keep VeraDesk background service", "השאר את שירות הרקע של VeraDesk פעיל"),
        ("Ignore Battery Optimizations", "התעלם מאופטימיזציות סוללה"),
        ("android_open_battery_optimizations_tip", "אם ברצונך לבטל תכונה זו, אנא עבור לדף ההגדרות של יישום VeraDesk , מצא והיכנס ל[סוללה], ובטל את הסימון מ-[לא מוגבל]"),
        ...
        ("config_input", "כדי לשלוט בשולחן העבודה המרוחק באמצעות מקלדת, עליך להעניק ל-VeraDesk הרשאות \"מעקב קלט\"."),
        ("config_microphone", "כדי לדבר מרחוק, עליך להעניק ל-VeraDesk הרשאות \"הקלטת שמע\"."),
        ...
        ("still_click_uac_tip", "עדיין נדרש מהמשתמש המרוחק לאשר את חלון ה-UAC של VeraDesk"),
        ...
        ("View Mode", "מצב תצוגה"),
        ("verify_veradesk_password_tip", "אמת סיסמת VeraDesk"),
        ...
        ("scam_text1", "אם אתה בשיחת טלפון עם מישהו שאינך מכיר ואינך סומך עליו שביקש ממך להשתמש ב-VeraDesk ולהתחיל את השירות, אל תמשיך ונתק מיד."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "אנא שדרג את VeraDesk Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("selinux_tip", "SELinux מופעל במכשיר שלך, מה שעלול למנוע מ-VeraDesk לפעול כראוי כצד הנשלט."),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "אנא שדרג את לקוח VeraDesk לגרסה {} או חדשה יותר בצד המרוחק!"),
        ...
        ("allow-insecure-tls-fallback-tip", "כברירת מחדל, VeraDesk מאמת את אישור השרת עבור פרוטוקולים המשתמשים ב-TLS.\nכאשר אפשרות זו מופעלת, VeraDesk יחזור לדילוג על שלב האימות וימשיך במקרה של כשל באימות."),
        ("Disable UDP", "השבת UDP"),
        ("disable-udp-tip", "קובע אם להשתמש ב-TCP בלבד.\nכאשר אפשרות זו מופעלת, VeraDesk לא ישתמש יותר ב-UDP 21116, ובמקום זאת ייעשה שימוש ב-TCP 21116."),
        ("server-oss-not-support-tip", "הערה: גרסת ה-OSS של שרת VeraDesk אינה כוללת תכונה זו."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk אינו יכול לגשת להפעלת שולחן העבודה במכשיר המרוחק, ודאו שההפעלה פועלת ושVeraDesk יכול להשתמש בה"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk לא הצליח לקבל מסך שמיש מ-XDG Desktop Portal, ייתכן שספריית PipeWire ישנה מדי"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk לא הצליח לטעון רכיב GStreamer הדרוש ללכידת מסך ({})"),
