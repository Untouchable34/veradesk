...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A ligar à rede do VeraDesk..."),
        ...
        ("install_tip", "Devido ao UAC, o VeraDesk não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o VeraDesk no sistema."),
        ("Click to upgrade", "Clique para atualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao VeraDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao VeraDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o VeraDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [VeraDesk Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep VeraDesk background service", "Manter o serviço VeraDesk em funcionamento"),
        ("Ignore Battery Optimizations", "Ignorar optimizações de Bateria"),
        ("android_open_battery_optimizations_tip", "Se pretender desativar esta funcionalidade, aceda à próxima página de definições da aplicação VeraDesk, encontre e abra [Bateria], e desmarque [Sem restrições]"),
        ...
        ("Show VeraDesk", "Mostrar VeraDesk"),
        ("This PC", "Este PC"),
        ("or", "ou"),
        ("Elevate", "Elevar"),
        ...
        ("config_input", "Para controlar o ambiente de trabalho remoto com o teclado, é necessário conceder ao VeraDesk as permissões de \"Monitorização de Entrada\"."),
        ("config_microphone", "Para falar à distância, é necessário conceder ao VeraDesk as permissões de \"Gravar Áudio\"."),
        ...
        ("still_click_uac_tip", "Continua a exigir que o utilizador remoto clique em OK na janela do UAC do VeraDesk em execução."),
        ...
        ("verify_veradesk_password_tip", "Verificar palavra-passe do VeraDesk"),
        ...
        ("scam_text1", "Se estiver ao telefone com alguém que NÃO conhece NEM em quem confia e que lhe pediu para usar o VeraDesk e iniciar o serviço, não prossiga e desligue imediatamente."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Atualize o VeraDesk Server Pro para a versão {} ou mais recente!"),
        ...
        ("selinux_tip", "O SELinux está ativado no seu dispositivo, o que poderá impedir o VeraDesk de funcionar corretamente como lado controlado."),
        ...
        ("powered_by_me", "Disponibilizado pelo VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir a ligação apenas se a janela do VeraDesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço em segundo plano do VeraDesk"),
        ...
        ("About VeraDesk", "Sobre o VeraDesk"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Atualize o cliente VeraDesk para a versão {} ou mais recente no lado remoto!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por predefinição, o VeraDesk verifica o certificado do servidor para os protocolos que usam TLS.\nCom esta opção ativada, o VeraDesk recorrerá a ignorar a etapa de verificação e prosseguir em caso de falha de verificação."),
        ("Disable UDP", "Desativar UDP"),
        ("disable-udp-tip", "Controla se deve ser usado apenas TCP.\nQuando esta opção está ativada, o VeraDesk deixa de usar a UDP 21116, sendo usada a TCP 21116 em vez dela."),
        ("server-oss-not-support-tip", "NOTA: o VeraDesk server OSS não inclui esta funcionalidade."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "O VeraDesk não consegue aceder à sessão de ambiente de trabalho no dispositivo remoto, verifique se existe uma sessão ativa e se o VeraDesk a pode usar"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "O VeraDesk não conseguiu obter um ecrã utilizável do XDG Desktop Portal, a biblioteca PipeWire pode ser demasiado antiga"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "O VeraDesk não conseguiu carregar um componente do GStreamer necessário para capturar o ecrã ({})"),
