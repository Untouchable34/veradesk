...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "اپنے ڈیسک ٹاپ کو دور سے کنٹرول کرنے کے لیے آپ کو VeraDesk کو \"Accessibility\" کی اجازتیں دینا ہوں گی۔"),
        ("config_screen", "اپنے ڈیسک ٹاپ تک دور سے رسائی کے لیے آپ کو VeraDesk کو \"Screen Recording\" کی اجازتیں دینا ہوں گی۔"),
        ...
        ("android_input_permission_tip1", "کسی دور دراز آلے کو ماؤس یا ٹچ کے ذریعے آپ کے Android آلے کو کنٹرول کرنے کے لیے آپ کو VeraDesk کو \"Accessibility\" سروس استعمال کرنے کی اجازت دینا ہوگی۔"),
        ("android_input_permission_tip2", "براہِ کرم اگلے سسٹم سیٹنگز صفحے پر جائیں، [Installed Services] تلاش کر کے کھولیں اور [VeraDesk Input] سروس آن کریں۔"),
        ...
        ("Language", "زبان"),
        ("Keep VeraDesk background service", "VeraDesk پس منظر کی خدمت کو برقرار رکھیں"),
        ("Ignore Battery Optimizations", "بیٹری کی اصلاحات کو نظر انداز کریں"),
        ("android_open_battery_optimizations_tip", "اگر آپ یہ خصوصیت بند کرنا چاہتے ہیں تو براہِ کرم اگلے VeraDesk ایپلیکیشن سیٹنگز صفحے پر جائیں، [Battery] تلاش کر کے کھولیں اور [Unrestricted] کا نشان ہٹا دیں"),
        ...
        ("Show VeraDesk", "VeraDesk دکھائیں"),
        ("This PC", "یہ PC"),
        ("or", "یا"),
        ("Elevate", "علیٰ کریں"),
        ...
        ("config_microphone", "دور سے بات کرنے کے لیے آپ کو VeraDesk کو \"Record Audio\" کی اجازتیں دینا ہوں گی۔"),
        ...
        ("still_click_uac_tip", "پھر بھی ضروری ہے کہ دور دراز صارف چل رہے VeraDesk کی UAC ونڈو پر OK پر کلک کرے۔"),
        ...
        ("verify_veradesk_password_tip", "VeraDesk پاس ورڈ کی تصدیق کریں"),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "براہِ کرم VeraDesk Server Pro کو ورژن {} یا اس سے نئے پر اپ گریڈ کریں!"),
        ...
        ("selinux_tip", "آپ کے آلے پر SELinux فعال ہے، جو VeraDesk کو بطور کنٹرول شدہ فریق درست طور پر چلنے سے روک سکتا ہے۔"),
        ...
        ("allow-only-conn-window-open-tip", "کنکشن کی اجازت صرف اس صورت میں دیں جب VeraDesk ونڈو کھلی ہو"),
        ...
        ("floating_window_tip", "یہ VeraDesk کی پس منظر سروس کو برقرار رکھنے میں مدد دیتا ہے"),
        ...
        ("About VeraDesk", "رستڈیسک کے بارے میں"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "براہِ کرم دور دراز فریق پر VeraDesk کلائنٹ کو ورژن {} یا اس سے نئے پر اپ گریڈ کریں!"),
        ...
        ("allow-insecure-tls-fallback-tip", "پہلے سے طے شدہ طور پر VeraDesk TLS استعمال کرنے والے پروٹوکولز کے لیے سرور کے سرٹیفکیٹ کی تصدیق کرتا ہے۔\nیہ اختیار فعال ہونے پر، تصدیق ناکام ہونے کی صورت میں VeraDesk تصدیق کا مرحلہ چھوڑ کر آگے بڑھ جائے گا۔"),
        ("Disable UDP", "UDP کو غیر فعال کریں"),
        ("disable-udp-tip", "طے کرتا ہے کہ صرف TCP استعمال کیا جائے یا نہیں۔\nیہ اختیار فعال ہونے پر VeraDesk UDP 21116 مزید استعمال نہیں کرے گا، اس کی جگہ TCP 21116 استعمال ہوگا۔"),
        ("server-oss-not-support-tip", "نوٹ: VeraDesk سرور OSS میں یہ خصوصیت شامل نہیں ہے۔"),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk ریموٹ ڈیوائس کے ڈیسک ٹاپ سیشن تک رسائی حاصل نہیں کر سکتا، تصدیق کریں کہ ڈیسک ٹاپ سیشن چل رہا ہے اور VeraDesk اسے استعمال کر سکتا ہے"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk کو XDG Desktop Portal سے قابلِ استعمال اسکرین نہیں مل سکی، PipeWire لائبریری شاید بہت پرانی ہے"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk اسکرین ریکارڈنگ کے لیے درکار GStreamer جزو لوڈ نہیں کر سکا ({})"),
