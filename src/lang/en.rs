...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the VeraDesk network..."),
        ...
        ("install_tip", "Due to UAC, VeraDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install VeraDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant VeraDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant VeraDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow VeraDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [VeraDesk Input] service."),
        ...
        ("doc_mac_permission", "https://veranilsoft.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next VeraDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant VeraDesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant VeraDesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running VeraDesk."),
        ...
        ("View Mode", "View mode"),
        ("verify_veradesk_password_tip", "Verify VeraDesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use VeraDesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Please upgrade VeraDesk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://veranilsoft.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent VeraDesk from running properly as controlled side."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if VeraDesk window is open"),
        ...
        ("floating_window_tip", "It helps to keep VeraDesk background service"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Please upgrade the VeraDesk client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, VeraDesk verifies the server certificate for protocols using TLS.\nWith this option enabled, VeraDesk will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, VeraDesk will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: VeraDesk server OSS doesn't include this feature."),
