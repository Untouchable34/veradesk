...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till VeraDesk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte VeraDesk fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera VeraDesk på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge VeraDesk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge VeraDesk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [VeraDesk Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep VeraDesk background service", "Behåll VeraDesk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa VeraDesk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge VeraDesk behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge VeraDesk behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för VeraDesk."),
        ...
        ("verify_veradesk_password_tip", "Verifiera VeraDesk-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda VeraDesk och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Uppgradera VeraDesk Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra VeraDesk från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("powered_by_me", "Drivs av VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om VeraDesk-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla VeraDesk-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Uppgradera VeraDesk-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar VeraDesk serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar VeraDesk över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder VeraDesk inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: VeraDesk server OSS inkluderar inte denna funktion."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk kan inte nå skrivbordssessionen på fjärrenheten, kontrollera att en session körs och att VeraDesk kan använda den"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk fick ingen användbar skärm från XDG Desktop Portal, PipeWire-biblioteket kan vara för gammalt"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk kunde inte läsa in en GStreamer-komponent som krävs för skärminspelning ({})"),
