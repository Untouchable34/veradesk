...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua VeraDesk..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca VeraDesk să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala VeraDesk."),
        ("Click to upgrade", "Dă clic pentru a face upgrade"),
        ("Configure", "Configurează"),
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți VeraDesk acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți VeraDesk acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți VeraDesk să utilizeze serviciul „Accesibilitate\"."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [VeraDesk Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep VeraDesk background service", "Rulează serviciul VeraDesk în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației VeraDesk, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show VeraDesk", "Afișează VeraDesk"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi VeraDesk permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi VeraDesk permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din VeraDesk care rulează."),
        ...
        ("verify_veradesk_password_tip", "Verifică parola VeraDesk"),
        ...
        ("scam_text1", "Escrocii se pot da drept angajați ai asistenței tehnice și îți pot solicita să instalezi sau să rulezi VeraDesk pentru a-ți accesa dispozitivul."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Versiunea serverului VeraDesk Pro este mai mică decât {}. Te rugăm să o actualizezi."),
        ...
        ("input_source_2_tip", "Sursă de intrare 2 — folosește driver-ul VeraDesk pentru simulare la nivel de kernel"),
        ...
        ("powered_by_me", "Realizat cu VeraDesk"),
        ...
        ("ab_web_console_tip", "Gestionează agenda prin consola web VeraDesk Pro."),
        ...
        ("enable-bot-desc", "Configurează un bot Telegram pentru notificări VeraDesk. Introdu token-ul botului și ID-ul chat-ului."),
        ...
        ("About VeraDesk", "Despre VeraDesk"),
        ...
        ("web_id_input_tip", "Introdu ID-ul VeraDesk al dispozitivului la care vrei să te conectezi"),
        ("Download", "Descarcă"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Versiunea clientului VeraDesk de la distanță este mai mică decât {}. Te rugăm să o actualizezi pentru o compatibilitate completă."),
        ...
        ("server-oss-not-support-tip", "Serverul open-source nu suportă această funcție. Folosește VeraDesk Pro pentru funcționalitate completă."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk nu poate accesa sesiunea de desktop de pe dispozitivul de la distanță, verificați dacă o sesiune rulează și dacă VeraDesk o poate folosi"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk nu a putut obține un ecran utilizabil de la XDG Desktop Portal, biblioteca PipeWire poate fi prea veche"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk nu a putut încărca o componentă GStreamer necesară pentru capturarea ecranului ({})"),
