...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til VeraDesk-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan VeraDesk ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere VeraDesk på systemet"),
        ("Click to upgrade", "Klik for at opgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For at kontrollere dit skrivebord på afstand skal du give VeraDesk \"Access \" Rettigheder."),
        ("config_screen", "For at kunne få adgang til dit skrivebord langtfra, skal du give VeraDesk \"skærmstøtte \" tilladelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give VeraDesk mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [VeraDesk Input] tjenesten."),
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep VeraDesk background service", "Behold VeraDesk baggrundstjeneste"),
        ("Ignore Battery Optimizations", "Ignorér betteri optimeringer"),
        ("android_open_battery_optimizations_tip", "Hvis du ønsker at slukke for denne funktion, åbn VeraDesk appens indstillinger, tryk på [Batteri], og fjern flueben ved [Uden begrænsninger]"),
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia-grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open source-driveren, og aktivere software-rendering. En genstart af VeraDesk er nødvendig."),
        ("Always use software rendering", "Brug altid software-rendering"),
        ("config_input", "For at styre fjernskrivebordet med tastaturet, skal du give Veradesk rettigheder til at optage tastetryk"),
        ("config_microphone", "For at tale sammen over fjernstyring, skal du give VeraDesk rettigheder til at optage lyd"),
        ...
        ("still_click_uac_tip", "Kræver stadigvæk at fjernbrugeren skal trykke OK på UAC-vinduet ved kørsel af VeraDesk."),
        ...
        ("verify_veradesk_password_tip", "Bekræft VeraDesk-adgangskode"),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge VeraDesk til at forbinde til din PC, så stop med det samme, og læg på omgående."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Opgradér venligst VeraDesk Server Pro til version {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, hvilket kan forhindre VeraDesk i at køre normalt."),
        ...
        ("powered_by_me", "Drives af VeraDesk"),
        ...
        ("preset_password_warning", "Denne brugertilpassede udgave har en forudbestemt adgangskode. Alle der kender til denne adgangskode, kan få fuld adgang til din enhed. Hvis du ikke forventede dette, bør du afinstallere denne udgave af VeraDesk med det samme."),
        ...
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis VeraDesk-vinduet er synligt"),
        ...
        ("floating_window_tip", "Det hjælper til at holde VeraDesk-baggrundstjenesten kørende"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Opgrader venligst VeraDesk-klienten til version {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verificerer VeraDesk servercertifikatet for protokoller, der bruger TLS.\nNår denne indstilling er aktiveret, vil VeraDesk springe verificeringstrinnet over og fortsætte, hvis verificeringen mislykkes."),
        ("Disable UDP", "Deaktivér UDP"),
        ("disable-udp-tip", "Bestemmer, om der kun skal bruges TCP.\nNår denne indstilling er aktiveret, vil VeraDesk ikke længere bruge UDP 21116; i stedet bruges TCP 21116."),
        ("server-oss-not-support-tip", "BEMÆRK: VeraDesk Server OSS indeholder ikke denne funktion."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk kan ikke nå skrivebordssessionen på fjernenheden, kontrollér at en session kører, og at VeraDesk kan bruge den"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk kunne ikke få en brugbar skærm fra XDG Desktop Portal, PipeWire-biblioteket er måske for gammelt"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk kunne ikke indlæse en GStreamer-komponent, der kræves til skærmoptagelse ({})"),
        ...
        ("Close the distance.", ""),
        ("Pick a device. Connect. Carry on.", ""),
        ("devices online", ""),
        ("Your devices", ""),
        ("View all", ""),
        ("New connection", ""),
        ...
        ("Remote desktop", ""),
        ("Remote device ID", ""),
        ("leave empty if remembered", ""),
        ("Device password", ""),
        ("ID and password in one step. Press Enter to continue.", ""),
        ("Other connection types", ""),
        ("Permanent password", ""),
        ("Ask for approval on connect", ""),
        ("Incoming connections wait for your approval.", ""),
        ("A correct password connects without a prompt.", ""),
        ("Select a device, then choose Transfer file.", ""),
        ("Copy", ""),
    ].iter().cloned().collect();
}
