...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione a sa rete VeraDesk..."),
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), VeraDesk diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare VeraDesk a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a VeraDesk su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a VeraDesk su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a VeraDesk de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada VeraDesk]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep VeraDesk background service", "Mantene su servìtziu de VeraDesk in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione VeraDesk, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a VeraDesk sos permissos de 'Monitoràgiu insertada'."),
        ("config_microphone", "Per pòdere mutire, bisòngiat a frunire su premissu 'Registra àudio' a VeraDesk."),
        ...
        ("still_click_uac_tip", "Torra a pedire chi s'utente remotu seletziones 'AB' in sa ventana UAC de s'esecutzione de VeraDesk."),
        ...
        ("verify_veradesk_password_tip", "Cunfirma sa crae de VeraDesk"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare VeraDesk e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Atualiza VeraDesk Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de VeraDesk comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana VeraDesk est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de VeraDesk"),
        ...
        ("About VeraDesk", "Informatziones subra de VeraDesk"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Atualiza su cliente VeraDesk remotu a sa versione {} o prus noa!"),
        ...
        ("allow-insecure-tls-fallback-tip", "De manera predefinida, VeraDesk averguat su certificadu de su serbidore pro sos protocollos chi impreant TLS.\nCun custa optzione ativada, VeraDesk at a brincare s'averguada e at a sighire in casu de faddina de averguada."),
        ("Disable UDP", "Disabìlita UDP"),
        ("disable-udp-tip", "Controllat si impreare petzi su TCP.\nCun custa optzione ativada, VeraDesk no at a impreare prus sa UDP 21116, ma at a impreare sa TCP 21116."),
        ("server-oss-not-support-tip", "NOTA: su serbidore OSS de VeraDesk non includet custa funtzione."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk no podet acèdere a sa sessione de iscrivania in su dispositivu remotu, controlla chi una sessione siat ativa e chi VeraDesk la potzat impreare"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk no at pòdidu otènnere una schermada impreabile dae XDG Desktop Portal, sa libreria PipeWire podet èssere tropu betza"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk no at pòdidu carrigare unu cumponente de GStreamer netzessàriu pro registrare sa schermada ({})"),
