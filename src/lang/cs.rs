...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Připojování k VeraDesk síti..."),
        ...
        ("install_tip", "Kvůli řízení oprávnění v systému (UAC), VeraDesk v některých případech na protistraně nefunguje správně. Abyste se UAC vyhnuli, klikněte na níže uvedené tlačítko a nainstalujte tak VeraDesk do systému."),
        ("Click to upgrade", "Aktualizovat"),
        ("Configure", "Nastavit"),
        ("config_acc", "Aby bylo možné na dálku ovládat vaši plochu, je třeba aplikaci VeraDesk udělit oprávnění pro \"Zpřístupnění pro hendikepované\"."),
        ("config_screen", "Aby bylo možné přistupovat k vaší ploše na dálku, je třeba aplikaci VeraDesk udělit oprávnění pro \"Nahrávání obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby vzdálené zařízení mohlo ovládat vaše Android zařízení prostřednictví myši či dotyků, je třeba povolit, aby VeraDesk mohlo používat službu „Zpřístupnění hendikepovaným“."),
        ("android_input_permission_tip2", "Přejděte na následující stránku nastavení systému, najděte a přejděte do [Nainstalované služby] a zapněte službu [VeraDesk vstup]."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep VeraDesk background service", "Zachovat službu VeraDesk na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovat optimalizaci baterie"),
        ("android_open_battery_optimizations_tip", "Pokud chcete tuto funkci zakázat, přejděte na další stránku nastavení aplikace VeraDesk, najděte a zadejte [Baterie], zrušte zaškrtnutí [Neomezeno]."),
        ...
        ("Show VeraDesk", "Zobrazit VeraDesk"),
        ...
        ("config_input", "Chcete-li ovládat vzdálenou plochu pomocí klávesnice, musíte udělit oprávnění VeraDesk \"Sledování vstupu\"."),
        ("config_microphone", "Abyste mohli mluvit na dálku, musíte udělit oprávnění VeraDesk \"Nahrávat zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále vyžaduje, aby vzdálený uživatel kliknul na OK v okně UAC spuštěného VeraDesku."),
        ...
        ("verify_veradesk_password_tip", "Ověření hesla VeraDesk"),
        ...
        ("scam_text1", "Pokud telefonujete s někým, koho NEZNÁTE a komu NEDŮVĚŘUJETE a kdo vás požádal o použití služby VeraDesk a její spuštění, nepokračujte v hovoru a okamžitě zavěste."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Aktualizujte prosím VeraDesk Server Pro na verzi {} nebo novější!"),
        ...
        ("selinux_tip", "Na vašem zařízení je povolen SELinux, což může bránit správnému běhu VeraDesku jako řízené strany."),
        ...
        ("powered_by_me", "Poháněno společností VeraDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Povolit připojení pouze v případě, že je otevřené okno VeraDesk"),
        ...
        ("floating_window_tip", "Pomáhá udržovat službu VeraDesk na pozadí"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Upgradujte prosím klienta VeraDesk na verzi {} nebo novější na vzdálené straně!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Ve výchozím nastavení VeraDesk ověřuje certifikát serveru u protokolů používajících TLS.\nKdyž je tato možnost povolena, VeraDesk v případě selhání ověření přejde k přeskočení kroku ověření a bude pokračovat."),
        ("Disable UDP", "Zakázat UDP"),
        ("disable-udp-tip", "Určuje, zda se má používat pouze TCP.\nKdyž je tato možnost povolena, VeraDesk již nebude používat UDP 21116, místo toho se použije TCP 21116."),
        ("server-oss-not-support-tip", "POZNÁMKA: VeraDesk server OSS tuto funkci neobsahuje."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk nemůže získat přístup k relaci plochy na vzdáleném zařízení, ověřte, že relace běží a že ji VeraDesk může použít"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk nezískal z XDG Desktop Portal použitelnou obrazovku, knihovna PipeWire může být příliš stará"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk nemohl načíst komponentu GStreameru potřebnou k zachycení obrazovky ({})"),
