...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip1", "VeraDesk இந்த Android சாதனத்தை கட்டுப்படுத்த \"அணுகல் சேவைகள்\" அனுமதி தேவை."),
        ("android_input_permission_tip2", "சிஸ்டம் அமைப்புகளில் [நிறுவப்பட்ட சேவைகள்] கண்டுபிடித்து, VeraDesk சேவை இயக்கவும்."),
        ...
        ("Language", "மொழி"),
        ("Keep VeraDesk background service", "VeraDesk பின்புல சேவையை வைத்திரு"),
        ("Ignore Battery Optimizations", "பேட்டரி மேம்படுத்தல்களை புறக்கணி"),
        ("android_open_battery_optimizations_tip", "VeraDesk க்கு பேட்டரி மேம்படுத்தல் அணைக்க அமைப்புகளுக்கு செல்லவும்"),
        ...
        ("Show VeraDesk", "VeraDesk ஐ காட்டு"),
        ("This PC", "இந்த PC"),
        ("or", "அல்லது"),
        ("Elevate", "உயர்த்து"),
        ...
        ("verify_veradesk_password_tip", "veradesk_கடவுச்சொல்_சரிபார்ப்பு_குறிப்பு"),
        ...
        ("scam_text2", "VeraDesk ஊழியர் இவ்வாறு தொடர்பு கொள்ள மாட்டார்கள்"),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "VeraDesk Server Pro {} க்கு மேம்படுத்து"),
        ...
        ("selinux_tip", "SELinux இயக்கப்பட்டது, VeraDesk அனுமதி வேண்டும்"),
        ...
        ("enable-2fa-desc", "VeraDesk இரு காரணி அங்கீகாரம் ஆதரிக்கிறது"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "ரிமோட்_veradesk_கிளையன்டை_{}_மேம்படுத்து_குறிப்பு"),
        ...
        ("allow-insecure-tls-fallback-tip", "இயல்பாக, TLS ஐப் பயன்படுத்தும் நெறிமுறைகளுக்கு VeraDesk சர்வர் சான்றிதழை சரிபார்க்கிறது.\nஇந்த விருப்பம் இயக்கப்பட்டால், சரிபார்ப்பு தோல்வியடைந்தால் VeraDesk சரிபார்ப்பு படிநிலையைத் தவிர்த்து தொடரும்."),
        ("Disable UDP", "UDP ஐ முடக்கு"),
        ("disable-udp-tip", "TCP ஐ மட்டுமே பயன்படுத்த வேண்டுமா என்பதைக் கட்டுப்படுத்துகிறது.\nஇந்த விருப்பம் இயக்கப்பட்டால், VeraDesk இனி UDP 21116 ஐப் பயன்படுத்தாது, அதற்குப் பதிலாக TCP 21116 பயன்படுத்தப்படும்."),
        ("server-oss-not-support-tip", "குறிப்பு: VeraDesk சர்வர் OSS இந்த அம்சத்தை உள்ளடக்கவில்லை."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk தொலைநிலை சாதனத்தின் டெஸ்க்டாப் அமர்வை அணுக முடியவில்லை, ஒரு அமர்வு இயங்குகிறதா என்பதையும் VeraDesk அதைப் பயன்படுத்த முடியுமா என்பதையும் சரிபார்க்கவும்"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "XDG Desktop Portal-லிருந்து பயன்படுத்தக்கூடிய திரையை VeraDesk பெற முடியவில்லை, PipeWire நூலகம் மிகவும் பழையதாக இருக்கலாம்"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "திரைப் பதிவுக்குத் தேவையான GStreamer கூறை VeraDesk ஏற்ற முடியவில்லை ({})"),
