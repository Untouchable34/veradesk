...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, VeraDesk bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, VeraDesk'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ("Click to upgrade", "Yükseltmek için tıklayınız"),
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için VeraDesk'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için VeraDesk'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, VeraDesk'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [VeraDesk Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep VeraDesk background service", "VeraDesk arka plan hizmetini sürdürün"),
        ("Ignore Battery Optimizations", "Pil Optimizasyonlarını Yoksay"),
        ("android_open_battery_optimizations_tip", "Bu özelliği devre dışı bırakmak istiyorsanız lütfen bir sonraki VeraDesk uygulama ayarları sayfasına gidin, [Pil] ögesini bulun ve girin, [Sınırsız] ögesinin işaretini kaldırın"),
        ...
        ("Show VeraDesk", "VeraDesk'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ("Elevate", "Yükseltme"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için VeraDesk'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için VeraDesk'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan VeraDesk'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_veradesk_password_tip", "VeraDesk parolasını doğrulayın"),
        ...
        ("scam_text1", "Eğer tanımadığınız ve güvenmediğiniz birisiyle telefonda konuşuyorsanız ve sizden VeraDesk'i kullanmanızı ve hizmeti başlatmanızı istiyorsa devam etmeyin ve hemen telefonu kapatın."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "Lütfen VeraDesk Server Pro'yu {} veya daha yeni bir sürüme yükseltin!"),
        ...
        ("selinux_tip", "Cihazınızda SELinux etkin olduğundan, VeraDesk'in kontrollü tarafta düzgün çalışmasını engelleyebilir."),
        ...
        ("powered_by_me", "VeraDesk tarafından desteklenmektedir"),
        ...
        ("allow-only-conn-window-open-tip", "Yalnızca VeraDesk penceresi açıksa bağlantıya izin ver"),
        ...
        ("floating_window_tip", "VeraDesk arka plan hizmetini açık tutmaya yardımcı olur"),
        ...
        ("About VeraDesk", "VeraDesk Hakkında"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "Lütfen uzak tarafta VeraDesk istemcisini {} sürümüne veya daha yenisine güncelleyin!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Varsayılan olarak, VeraDesk sunucu sertifikasını TLS kullanarak protokoller için doğrular.\nBu seçenek etkinleştirildiğinde, doğrulama başarısızlığı durumunda VeraDesk doğrulama adımını atlayarak işleme devam eder."),
        ("Disable UDP", "UDP'yi devre dışı bırak"),
        ("disable-udp-tip", "Yalnızca TCP kullanılıp kullanılmayacağını kontrol eder.\nBu seçenek etkinleştirildiğinde, VeraDesk artık UDP 21116'yı kullanmayacak, bunun yerine TCP 21116 kullanılacaktır."),
        ("server-oss-not-support-tip", "NOT: VeraDesk sunucu OSS'si bu özelliği içermemektedir."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk uzak cihazdaki masaüstü oturumuna erişemiyor, bir masaüstü oturumunun çalıştığını ve VeraDesk tarafından kullanılabildiğini doğrulayın"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk, XDG Desktop Portal'dan kullanılabilir bir ekran alamadı, PipeWire kitaplığı çok eski olabilir"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk ekran yakalama için gereken GStreamer bileşenini yükleyemedi ({})"),
        ("Password (leave empty if remembered)", "Şifre (kayıtlıysa boş bırak)"),
        ("Connection center", "Bağlantı merkezi"),
        ("Online", "Çevrimiçi"),
        ("Offline", "Çevrimdışı"),
        ("Connection starts here", "Bağlantı buradan başlar"),
        ("This device", "Bu cihaz"),
        ("Selected remote device", "Seçili uzak cihaz"),
        ("Other device", "Diğer cihaz"),
        ("Your personal workspace", "Kişisel çalışma alanın"),
        ("Close the distance.", "Mesafeyi aradan çıkar."),
        ("Pick a device. Connect. Carry on.", "Cihazını seç. Bağlan. Kaldığın yerden devam et."),
        ("devices online", "cihaz çevrimiçi"),
        ("Your devices", "Cihazların"),
        ("View all", "Tümünü gör"),
        ("New connection", "Yeni bağlantı"),
        ("Remote device", "Uzak cihaz"),
        ("Remote desktop", "Uzak masaüstü"),
        ("Remote device ID", "Uzak cihaz ID'si"),
        ("leave empty if remembered", "kayıtlıysa boş bırak"),
        ("Device password", "Cihaz şifresi"),
        ("ID and password in one step. Press Enter to continue.", "ID ve şifre tek adımda. Enter ile devam et."),
        ("Other connection types", "Diğer bağlantı türleri"),
        ("Permanent password", "Kalıcı şifre"),
        ("Ask for approval on connect", "Bağlantıda onay iste"),
        ("Incoming connections wait for your approval.", "Gelen bağlantılar onayını bekler."),
