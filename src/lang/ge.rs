...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "VeraDesk ქსელთან დაკავშირება..."),
        ...
        ("install_tip", "ზოგიერთ შემთხვევაში UAC-ის გამო VeraDesk შეიძლება არასწორად მუშაობდეს დაშორებულ კვანძზე. UAC-თან დაკავშირებული პრობლემების თავიდან ასაცილებლად დააჭირეთ ქვემოთ მოცემულ ღილაკს სისტემაში VeraDesk-ის დასაყენებლად."),
        ("Click to upgrade", "დააჭირეთ განახლებისთვის"),
        ("Configure", "კონფიგურაცია"),
        ("config_acc", "თქვენი სამუშაო მაგიდის დისტანციური მართვისთვის უნდა მიანიჭოთ VeraDesk-ს \"წვდომის\" უფლებები"),
        ("config_screen", "სამუშაო მაგიდაზე დისტანციური წვდომისთვის უნდა მიანიჭოთ VeraDesk-ს \"ეკრანის ანაბეჭდის\" უფლებები"),
        ...
        ("android_input_permission_tip1", "იმისთვის, რომ დაშორებულმა მოწყობილობამ შეძლოს თქვენი Android-მოწყობილობის მართვა თაგუნათი ან შეხებით, საჭიროა VeraDesk-ისთვის \"სპეციალური შესაძლებლობების\" სერვისის გამოყენების უფლების მინიჭება."),
        ("android_input_permission_tip2", "გადადით სისტემის პარამეტრების შესაბამის გვერდზე, იპოვეთ და შედით \"დაინსტალირებულ სერვისებში\", ჩართეთ \"VeraDesk Input\" სერვისი."),
        ...
        ("Language", "ენა"),
        ("Keep VeraDesk background service", "VeraDesk-ის ფონური სერვისის შენარჩუნება"),
        ...
        ("Show VeraDesk", "VeraDesk-ის ჩვენება"),
        ...
        ("config_input", "დისტანციური სამუშაო მაგიდის კლავიატურით სამართავად, საჭიროა VeraDesk-ისთვის \"შეყვანის მონიტორინგის\" უფლების მინიჭება."),
        ("config_microphone", "დისტანციურ მხარესთან სასაუბროდ, საჭიროა VeraDesk-ისთვის \"აუდიოს ჩაწერის\" უფლების მინიჭება."),
        ...
        ("still_click_uac_tip", "კვლავ საჭიროა, რომ დისტანციურმა მომხმარებელმა დააჭიროს \"OK\"-ს UAC ფანჯარაში VeraDesk-ის გაშვებისას."),
        ...
        ("verify_veradesk_password_tip", "დაადასტურეთ VeraDesk-ის პაროლი"),
        ...
        ("scam_text1", "თუ ტელეფონით ესაუბრებით ვინმეს, ვისაც არ იცნობთ და არ ენდობით, და ის გთხოვთ გამოიყენოთ VeraDesk და გაუშვათ მისი სერვისი, არ გააგრძელოთ და დაუყოვნებლივ შეწყვიტეთ საუბარი."),
        ...
        ("upgrade_veradesk_server_pro_to_{}_tip", "განაახლეთ VeraDesk Server Pro ვერსიამდე {} ან უფრო ახალი!"),
        ...
        ("selinux_tip", "თქვენს მოწყობილობაზე ჩართულია SELinux, რამაც შეიძლება ხელი შეუშალოს VeraDesk-ის სწორ მუშაობას მართულ მხარეზე."),
        ("Change view", "ხედი"),
        ...
        ("powered_by_me", "VeraDesk-ზე დაფუძნებული"),
        ...
        ("allow-only-conn-window-open-tip", "დაშვება მხოლოდ მაშინ, როცა VeraDesk-ის ფანჯარა გახსნილია"),
        ...
        ("floating_window_tip", "ეხმარება VeraDesk-ის ფონური სერვისის შენარჩუნებას"),
        ...
        ("About VeraDesk", "VeraDesk-ის შესახებ"),
        ...
        ("upgrade_remote_veradesk_client_to_{}_tip", "განაახლეთ VeraDesk კლიენტი ვერსიამდე {} ან უფრო ახალი დისტანციურ მხარეზე!"),
        ...
        ("allow-insecure-tls-fallback-tip", "ნაგულისხმევად VeraDesk ამოწმებს სერვერის სერტიფიკატს TLS-ის გამოყენებისას პროტოკოლებისთვის.\nამ პარამეტრის ჩართვისას VeraDesk გადავა შემოწმების ეტაპის გამოტოვებაზე და გააგრძელებს მუშაობას შემოწმების წარუმატებლობის შემთხვევაში."),
        ("Disable UDP", "UDP-ის გამორთვა"),
        ("disable-udp-tip", "აკონტროლებს, გამოვიყენოთ თუ არა მხოლოდ TCP.\nამ პარამეტრის ჩართვისას VeraDesk აღარ გამოიყენებს UDP 21116-ს, სანაცვლოდ გამოყენებული იქნება TCP 21116."),
        ("server-oss-not-support-tip", "შენიშვნა: VeraDesk server OSS არ მოიცავს ამ ფუნქციას."),
        ...
        ("VeraDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that VeraDesk can use it", "VeraDesk-ს არ შეუძლია დისტანციური მოწყობილობის სამუშაო მაგიდის სესიასთან წვდომა, შეამოწმეთ, რომ სესია გაშვებულია და VeraDesk-ს შეუძლია მისი გამოყენება"),
        ...
        ("VeraDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "VeraDesk-მა ვერ მიიღო გამოსადეგი ეკრანი XDG Desktop Portal-იდან, PipeWire-ის ბიბლიოთეკა შესაძლოა ძალიან ძველია"),
        ("VeraDesk could not load a GStreamer component needed for screen capture ({})", "VeraDesk-მა ვერ ჩატვირთა ეკრანის ჩაწერისთვის საჭირო GStreamer-ის კომპონენტი ({})"),
