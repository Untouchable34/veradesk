...
pub fn start(args: &mut [String]) {
    ...
    #[cfg(all(target_os = "linux", feature = "inline"))]
    {
        ...
        let mut so_path = "/usr/share/veradesk/libsciter-gtk.so".to_owned();
        for (prefix, dir) in [
            ("", "/usr"),
            ("", "/app"),
            (&app_dir, "/usr"),
        ...
        .iter()
        {
            let path = format!("{prefix}{dir}/share/veradesk/libsciter-gtk.so");
    ...
    // https://github.com/rustdesk/veradesk/issues/132#issuecomment-886069737
    #[cfg(windows)]
