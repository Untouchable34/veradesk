...
/// FFI for veradesk core's main entry.
/// Return true if the app should continue running with UI(possibly Flutter), false if the app should exit.
#[cfg(not(windows))]
#[no_mangle]
pub extern "C" fn veradesk_core_main() -> bool {
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
...
#[cfg(windows)]
#[no_mangle]
pub extern "C" fn veradesk_core_main_args(args_len: *mut c_int) -> *mut *mut c_char {
...
#[cfg(windows)]
#[no_mangle]
pub extern "C" fn veradesk_is_disable_installation() -> c_int {
...
#[cfg(windows)]
#[no_mangle]
pub unsafe extern "C" fn get_veradesk_app_name(buffer: *mut u16, length: i32) -> i32 {
