...
///
/// Note:
/// On linux, we use dbus to communicate between multiple veradesk processes.
...
const DBUS_NAME: &str = "org.veradesk.veradesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "VeraDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.veradesk.veradesk /dbus org.veradesk.veradesk.NewConnection string:'PEER_ID'`
