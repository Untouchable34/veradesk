...
pub fn core_main() -> Option<Vec<String>> {
    ...
    if args.is_empty() || crate::common::is_empty_uni_link(&args[0]) {
        ...
        // Example: `sudo veradesk --option custom-rendezvous-server` should query the
            ...
            if args[0] == "--uninstall" {
                ...
                if crate::virtual_display_manager::is_virtual_display_supported() {
                    hbb_common::allow_err!(
                        crate::virtual_display_manager::veradesk_idd::install_update_driver()
                    );
                }
                return None;
  ...
  --device_name"#
            ...
            // veradesk service kill `veradesk --` processes
            #[cfg(target_os = "linux")]
            if args.len() > 2 {
