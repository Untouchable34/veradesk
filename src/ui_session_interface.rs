...
impl<T: InvokeUiSession> Session<T> {
    ...
    fn _handle_key_non_flutter_simulation(
        ...
        // https://github.com/rustdesk/veradesk/blob/07cf1b4db5ef2f925efd3b16b87c33ce03c94809/src/keyboard.rs#L1029
    ...
    pub fn printer_response(&self, id: i32, path: String, printer_name: String) {
        ...
        let to = std::env::temp_dir().join(format!("veradesk_printer_{id}"));
    ...
    if handler.is_port_forward() {
        ...
        if handler.is_rdp() {
            ...
            if handler.args.len() != 3
                ...
                || port <= 0
            {
                handler.on_error("Invalid arguments, usage:<br><br> veradesk --port-forward remote-id listen-port remote-host remote-port");
            }
