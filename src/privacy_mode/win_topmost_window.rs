...
pub(super) const PRIVACY_WINDOW_CLASS: &'static str = "VeraDeskPrivacyWindowClass";
pub(super) const PRIVACY_WINDOW_NAME: &'static str = "VeraDeskPrivacyWindow";
...
const WM_VERADESK_SHOW_WINDOWS: u32 = WM_APP + 3;
const WM_VERADESK_HIDE_WINDOWS: u32 = WM_APP + 4;
...
fn set_privacy_windows_visible(hwnds: &[HWND], show: bool) -> ResultType<usize> {
    ...
    let message = if show {
        WM_VERADESK_SHOW_WINDOWS
    } else {
        WM_VERADESK_HIDE_WINDOWS
    };
    let mut posted = 0;
