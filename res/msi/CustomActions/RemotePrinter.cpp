...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_DRIVER_INF_PATH = L"drivers\\VeraDeskPrinterDriver\\VeraDeskPrinterDriver.inf";
    LPCWCH RD_PRINTER_DRIVER_NAME = L"VeraDesk v4 Printer Driver";
    LPCWCH RD_DEFAULT_APP_NAME = L"VeraDesk";
    ...
    {
        // If the printer is used after the spooler service is started. E.g., printing a document through VeraDesk Printer.
